...
public interface UserConnectivityConstant {
	 ...
	 */
	String LDAP_GROUP_FILTER = "(|((objectClass=organizationalRole)(objectClass=groupOfNames)(objectClass=groupOfUniqueNames)(objectClass=group)))";
	...
	/**
	 * Constant for initials.
	 */
	String USER_NAME_INITIALS = "initials";
	...
	String SUR_NAME = "sn";
	/**
	 * Variable for start curly-brace-start symbol
	 */
	...
	/**
	 * Variable for white space character.
	 */
	String WHITE_SPACE = " ";
}
