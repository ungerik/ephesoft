...
public class OfficeDocumentConverter {
	...
	public void convert(byte[] buffer, File outputFile, DocumentFormat outputFormat) {
		StandardConversionTask conversionTask = new StandardConversionTask(buffer, outputFile, outputFormat);
		conversionTask.setDefaultLoadProperties(defaultLoadProperties);
		officeManager.execute(conversionTask);
	}
}
