...
public class BatchInstancePluginPropertiesService implements PluginPropertiesService {
		...
		if (container != null) {
			...
			if (allDocTypes != null && !allDocTypes.isEmpty()) {
				...
				for (String string : docTypesNames) {
					...
					tempDocType.setTableInfos(serializedDocType.getTableInfos());
						...
						if (docType != null) {
							...
							if (allPageTypes != null && !allPageTypes.isEmpty()) {
								...
								if (allTempKeySet != null && allTempKeySet.contains(pageTypeName)) {
									...
									tempDocType.setFirstPageProjectFileName(docType.getFirstPageProjectFileName());
									tempDocType.setSecondPageProjectFileName(docType.getSecondPageProjectFileName());
									tempDocType.setThirdPageProjectFileName(docType.getThirdPageProjectFileName());
									tempDocType.setFourthPageProjectFileName(docType.getFourthPageProjectFileName());
	...
	public Set<String> getInMemoryPropertiesKeys() {
		return pluginPropertiesDao.getKeys();
	}
}
