...
package com.ephesoft.dcma.batch.exception;

import javax.xml.bind.JAXBException;

/**
 * Thrown when there is some error in generating or parsing the XML signatuure. This can be Batch.xml signature or the HOCR xml
 * signature.
 * 
 * @author Ephesoft.
 * @version 1.0
 * @see Exception
 **/
public class XMLSignatureException extends JAXBException {
	...
	/**
	 * Constructs a new XMLSignatureException with <code>null</code> as its detail message. The cause is not initialized, and may
	...
	/**
	 * Constructs a new XMLSignature Exception with the specified cause and a detail message of
	 ...
	 *            permitted, and indicates that the cause is nonexistent or unknown.)
	 */
	public XMLSignatureException(Throwable throwable) {
		super(throwable);
	}
}
