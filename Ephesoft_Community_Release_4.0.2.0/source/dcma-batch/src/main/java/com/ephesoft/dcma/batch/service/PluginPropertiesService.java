...
public interface PluginPropertiesService {
	 ...
	 */
	public DocumentType getDocumentTypeByName(String batchIdentifier, String docTypeName);
	 ...
	 * @param batchIdentifier {@link String}
	 * @param docTypeName {@link String}
	 * @return {@link List}<{@link FunctionKey}>
	 */
	public List<FunctionKey> getFunctionKeys(String batchIdentifier, String docTypeName);

	/**
	 * Method to create serialized file for Batch class.
	 * 
	 * @param batchClassIdentifier {@link String} Batch class identifier for whom serialised file is to be created.
	 */
