...
public interface KeyFileLocatorService {

	public File getBatchClassKeyFile(String batchClassIdentifier) throws KeyNotFoundException;

	public String getBatchClassKeyDirectory(String batchClassIdentifier);

	public File getApplicationKeyFile() throws KeyNotFoundException;

	public String getApplicationKeyDirectory();

	public File getBatchInstanceKeyFile(String batchInstanceIdentifier) throws KeyNotFoundException;

	public String getBatchInstanceKeyDirectory(String batchInstanceIdentifier);

	public String getLuceneKeyDirectory(String batchClassIdentifier);

	public File getLuceneKeyFile(String batchClassIdentifier) throws KeyNotFoundException;

	public File getFuzzyKeyFile(String batchClassIdentifier) throws KeyNotFoundException;

	public String getFuzzyKeyDirectory(String batchClassIdentifier);
