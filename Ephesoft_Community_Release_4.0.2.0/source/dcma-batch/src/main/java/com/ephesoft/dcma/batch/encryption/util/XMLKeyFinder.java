...
public class XMLKeyFinder {
	...
	public byte[] getKey(final File fileToCrypt) throws KeyNotFoundException {
		return null;
	}

	public PrivateKeyEncryptionAlgorithm getEncryptionAlgorithm(final File fileToCrypt) {
		return null;
	}


	public void generateKey(final File fileToCrypt) throws KeyGenerationException, KeyNotFoundException {
	}
}
