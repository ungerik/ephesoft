...
public interface KVFinderConstants {
	...
	/**
	 * Constant defined for fuzzy matching default location.
	 */
	int DEFAULT_FUZZY_SEARCH_LOCATION = 0;

	/**
	 * Constant for defing the minimun fuzziness threshold value.
	 */
	float MINIMUM_FUZZY_THRESHOLD = 0.0f;

	/**
	 * Constant for defing the maximum fuzziness threshold value.
	 */
	float MAXIMUM_FUZZY_THRESHOLD = 1.0f;
	
	/**
	 * Constant for difference in offsets value to check mid point algo used.
	 */
	int MAX_OFFSET_DIFFERENCE = 2;
	
	/**
	 * Constant for defining difference max span difference.
	 */
	int MAX_SPAN_DIFFERENCE = 5;
}
