...
public class OutputDataCarrier {
	...
	/**
	 * Span tag information for Key
	 */
	private Span keySpan;
	 ...
	 * @param valueSpan
	 */
	public OutputDataCarrier(final Span span, final float confidence, final String value, final String key, final Span valueSpan) {
		super();
		this.span = span;
		this.confidence = confidence;
		this.value = value;
	 ...
	 * @param keySpan
	 */
	public void setKeySpan(Span keySpan) {
