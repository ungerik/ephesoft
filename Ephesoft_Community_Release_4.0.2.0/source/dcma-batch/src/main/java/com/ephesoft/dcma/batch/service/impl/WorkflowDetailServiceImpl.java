...
/**
 * This class is an implementation for providing services for creation and access to workflow details for a batch instance/ batch
 * class.
 * 
 * @author Ephesoft
 * @version 1.0
...
public class WorkflowDetailServiceImpl implements WorkflowDetailService {
	...
	/**
	 * Instance of {@link BatchClassWorkflowDetailDao}
	 */
	@Autowired
	private BatchClassWorkflowDetailDao batchClassWorkflowDetailDao;

	/**
	 * Instance of {@link BatchInstanceWorkflowDetailDao}
	 */
	@Autowired
	private BatchInstanceWorkflowDetailDao batchInstanceWorkflowDetailDao;

	@Override
	public void createBatchClassWorkflow(final WorkflowDetailContainer batchClassWorkflowContainer) {
		batchClassWorkflowDetailDao.createBatchClassWorkflow(batchClassWorkflowContainer);
	}

	@Override
	public WorkflowDetailContainer getWorkflowContainer(final String batchInstanceIdentifier) {
		return batchInstanceWorkflowDetailDao.getWorkflowContainer(batchInstanceIdentifier);
	}
}
