...
public abstract class BatchListBasePresenter <V extends View> extends BasePresenter<BatchListController, V> {

	protected BatchListServiceAsync rpcService;
	
	public BatchListBasePresenter(BatchListController controller, V view) {
