 ...
 */
public class RegexBuilderDetailPresenter extends SystemConfigInlinePresenter<RegexBuilderDetailView> {
	 ...
	 */
	public RegexBuilderDetailPresenter(final SystemConfigController controller, final RegexBuilderDetailView view) {
