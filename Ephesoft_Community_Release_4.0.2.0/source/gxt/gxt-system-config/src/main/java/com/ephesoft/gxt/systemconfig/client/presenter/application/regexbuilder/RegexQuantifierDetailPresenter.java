 ...
 */
public class RegexQuantifierDetailPresenter extends SystemConfigInlinePresenter<RegexQuantifierDetailView> {
	 ...
	 */
	public RegexQuantifierDetailPresenter(final SystemConfigController controller, final RegexQuantifierDetailView view) {
