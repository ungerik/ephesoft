...
public class LicenseDetailsView extends SystemConfigCompositeView<LicenseDetailsPresenter> {

	private LicenseDetailsGridView licenseDetailsGridView;

	public LicenseDetailsView() {
		licenseDetailsGridView = new LicenseDetailsGridView();
	}
	...
	public SystemConfigInlineView<?> getCenterPanelView() {
		return licenseDetailsGridView;
	}

	public LicenseDetailsGridView getLicenseDetailsGridView() {
		return licenseDetailsGridView;
	}
}
