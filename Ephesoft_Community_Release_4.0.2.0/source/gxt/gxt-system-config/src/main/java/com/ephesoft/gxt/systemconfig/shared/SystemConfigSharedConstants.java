...
package com.ephesoft.gxt.systemconfig.shared;

/**
 * This <code>CustomWorkflowSharedConstants</code> class is responsible for holding the shared constants for the Custom workflow
 * module. It includes the constants that can be shared among client and server side.
 * 
 * @author Ephesoft
 * 
 ...
 */
public interface SystemConfigSharedConstants {
	...
	/**
	 * Constant used to display title on Custom Work-Flow title page
	 */
	String CUSTOM_WORKFLOW_HTML_TITLE = "custom_work_flow_title";
}
