...
import com.ephesoft.gxt.systemconfig.client.presenter.connectionmanager.ConnectionMenuPresenter;
...
public class ConnectionMenuView extends SystemConfigInlineView<ConnectionMenuPresenter> {

	interface Binder extends UiBinder<Widget, ConnectionMenuView> {
	}
	...
	private void setWidgetID() {
		WidgetUtil.setID(batchClassMenuBar, "CMV_operations_MenuBar");
		WidgetUtil.setID(addMenuItem, "CMV_add_MenuItem");
		WidgetUtil.setID(editMenuItem, "CMV_edit_MenuItem");
		WidgetUtil.setID(deleteMenuItem, "CMV_delete_MenuItem");
	}
	...
	private void addMenuItemActionEvents() {
		addMenuItem.setScheduledCommand(new ScheduledCommand() {
			...
			@Override
			public void execute() {
				presenter.showAddConnectionView();
			}
		});
		...
		deleteMenuItem.setScheduledCommand(new ScheduledCommand() {
			...
			@Override
			public void execute() {
				presenter.deleteSelectedConnection();
			}
		});
		...
		editMenuItem.setScheduledCommand(new ScheduledCommand() {
			...
			@Override
			public void execute() {
				presenter.showEditConnectionView();
			}
		});
	}
