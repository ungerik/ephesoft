...
import com.ephesoft.gxt.systemconfig.client.view.application.regexpool.RegexPatternToolBar;
 ...
 */
public class RegexPatternToolBarPresenter extends SystemConfigInlinePresenter<RegexPatternToolBar> {

	/**
	 * The Interface CustomEventBinder.
	 */
	interface CustomEventBinder extends EventBinder<RegexPatternToolBarPresenter> {
	}
	 ...
	 */
	public RegexPatternToolBarPresenter(SystemConfigController controller, RegexPatternToolBar view) {
	 ...
	 */
	public void deleteMultipleRegexPatterns() {
		controller.getEventBus().fireEvent(new StartMultipleRegexPatternDeletionEvent());
	}

	/**
	 * addRegexPattern method used to fire AddRegexPatternEvent
	 */
	public void addRegexPattern() {
		controller.getEventBus().fireEvent(new AddRegexPatternEvent());
	}
}
