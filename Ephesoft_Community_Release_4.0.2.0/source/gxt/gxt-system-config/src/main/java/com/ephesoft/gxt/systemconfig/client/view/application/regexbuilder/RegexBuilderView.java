 ...
 * 
 */
public class RegexBuilderView extends SystemConfigCompositeView<RegexBuilderPresenter> {
	...
	public RegexBuilderView() {
		regexBuilderToolBar = new RegexBuilderToolBar();
		regexBuilderMainView = new RegexBuilderMainView();
