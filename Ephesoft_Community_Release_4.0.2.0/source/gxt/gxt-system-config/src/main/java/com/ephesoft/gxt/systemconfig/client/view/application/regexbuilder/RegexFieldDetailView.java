...
import com.ephesoft.gxt.systemconfig.client.presenter.application.regexbuilder.RegexFieldDetailPresenter;
 ...
 */
public class RegexFieldDetailView extends SystemConfigInlineView<RegexFieldDetailPresenter> {
	...
	public RegexFieldDetailView() {
		...
		specialCharLabel.setText(LocaleDictionary.getConstantValue(RegexBuilderConstants.ANY_SPECIAL_CHARACTER_TEXT));
		...
		invalidDigitRangeLabel.setText(LocaleDictionary.getConstantValue(RegexBuilderConstants.INVALID_DIGIT_RANGE));
		invalidLowerCaseLetterRangeLabel.setText(LocaleDictionary.getConstantValue(RegexBuilderConstants.INVALID_LOWER_CASE_RANGE));
		invalidUpperCaseLetterRangeLabel.setText(LocaleDictionary.getConstantValue(RegexBuilderConstants.INVALID_UPPER_CASE_RANGE));
		lowerCaseLetterRangeLabel.setText(LocaleDictionary.getConstantValue(RegexBuilderConstants.LOWER_CASE_LETTER_RANGE));
		upperCaseLetterRangeLabel.setText(LocaleDictionary.getConstantValue(RegexBuilderConstants.UPPER_CASE_LETTER_RANGE));

		startsEndsStringComboBox.add(LocaleDictionary.getConstantValue(RegexBuilderConstants.MATCH_STRING_CONTAINS));
		startsEndsStringComboBox.add(LocaleDictionary.getConstantValue(RegexBuilderConstants.MATCH_STRING_STARTS_WITH));
		startsEndsStringComboBox.add(LocaleDictionary.getConstantValue(RegexBuilderConstants.MATCH_STRING_ENDS_IN));
		startsEndsStringComboBox.add(LocaleDictionary.getConstantValue(RegexBuilderConstants.MATCH_STRING_STARTS_WITH_ENDS_IN));
	...
	private void setDefaultValues() {
		...
		startsEndsStringComboBox.setValue(LocaleDictionary.getConstantValue(RegexBuilderConstants.MATCH_STRING_CONTAINS));
		startsEndsStringComboBox.setText(LocaleDictionary.getConstantValue(RegexBuilderConstants.MATCH_STRING_CONTAINS));
		...
		specialCharTextField.setText(SystemConfigConstants.EMPTY_STRING);
	...
	private void addCSSStyles() {
		...
		// CSS for Label.
		exactTextLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		...
		exactTextLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		textInRangeLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		textInRangeLabel.addStyleName(CoreCommonConstants.BOLD_TEXT_CSS);
		textInRangeLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		matchExactTextLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		matchExactTextLabel.addStyleName(CoreCommonConstants.WIDTH_200_PX);
		matchExactTextLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		lowerCaseLetterLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		lowerCaseLetterLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);
		lowerCaseLetterLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		upperCaseLetterLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		upperCaseLetterLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);
		upperCaseLetterLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		digitLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		digitLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);
		digitLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		freeTextLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		freeTextLabel.addStyleName(CoreCommonConstants.WIDTH_200_PX);
		freeTextLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		anyCharacterLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		anyCharacterLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);
		anyCharacterLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		wordBoundaryLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		wordBoundaryLabel.addStyleName(CoreCommonConstants.WIDTH_200_PX);
		wordBoundaryLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		specialCharLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		specialCharLabel.addStyleName(CoreCommonConstants.WIDTH_200_PX);
		specialCharLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		anyLetterLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		anyLetterLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);

		whiteSpaceLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		whiteSpaceLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);
		whiteSpaceLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		digitRangeLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		digitRangeLabel.addStyleName(CoreCommonConstants.WIDTH_200_PX);

		digitDashLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		digitDashLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);
		digitDashLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);
		digitDashLabel.addStyleName(SystemConfigConstants.HYPHEN_SPACE);

		lowerCaseLetterRangeLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		lowerCaseLetterRangeLabel.addStyleName(CoreCommonConstants.WIDTH_200_PX);
		lowerCaseLetterRangeLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		lowerCaseLetterDashLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		lowerCaseLetterDashLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);
		lowerCaseLetterDashLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);
		lowerCaseLetterDashLabel.addStyleName(SystemConfigConstants.HYPHEN_SPACE);

		upperCaseLetterRangeLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		upperCaseLetterRangeLabel.addStyleName(CoreCommonConstants.WIDTH_200_PX);
		upperCaseLetterRangeLabel.addStyleName(CoreCommonConstants.WIDTH_200_PX);
		upperCaseLetterRangeLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		upperCaseLetterDashLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		upperCaseLetterDashLabel.addStyleName(CoreCommonConstants.BUTTON_MARGIN_RIGHT_CSS);
		upperCaseLetterDashLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);
		upperCaseLetterDashLabel.addStyleName(SystemConfigConstants.HYPHEN_SPACE);

		invalidDigitRangeLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		...
		invalidDigitRangeLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		invalidLowerCaseLetterRangeLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		...
		invalidLowerCaseLetterRangeLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		invalidUpperCaseLetterRangeLabel.addStyleName(SystemConfigConstants.REGEX_BUILDER_LABEL_CSS);
		...
		invalidUpperCaseLetterRangeLabel.addStyleName(SystemConfigConstants.LABEL_TEXT_CSS);

		invalidDigitRangeLabel.addStyleName(SystemConfigConstants.DATE_BOX_ERROR_MSG_NEW);
		invalidLowerCaseLetterRangeLabel.addStyleName(SystemConfigConstants.DATE_BOX_ERROR_MSG_NEW);
		invalidUpperCaseLetterRangeLabel.addStyleName(SystemConfigConstants.DATE_BOX_ERROR_MSG_NEW);
	...
	private void addHelpMessages() {
		exactTextRadioButton.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.MATCH_EXACT_TEXT_HELP_MESSAGE));
		textInRangeRadioButton.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.TEXT_IN_RANGE_HELP_MESSAGE));
		matchExactTextCheckBox.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.MATCH_EXACT_TEXT_HELP_MESSAGE));
		anyCharacterCheckBox.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.ANY_CHARACTER_HELP_MESSAGE));
		lowerCaseLetterCheckBox
				.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.LOWER_CASE_LETTER_RANGE_HELP_MESSAGE));
		upperCaseLetterCheckBox.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.UPPER_CASE_LETTER_HELP_MESSAGE));
		...
		specialCharCheckBox.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.ANY_SPECIAL_CHARACTER_TEXT_HELP_MESSAGE));
		anyLetterCheckBox.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.ANY_LETTER_TEXT_HELP_MESSAGE));
		whiteSpaceCheckBox.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.ANY_WHITE_SPACE_CHARACTER_HELP_MESSAGE));
		digitRangeCheckBox.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.ANY_DIGIT_IN_RANGE_HELP_MESSAGE));
		lowerCaseLetterRangeCheckBox.setTitle(LocaleDictionary
				.getConstantValue(RegexBuilderConstants.LOWER_CASE_LETTER_RANGE_HELP_MESSAGE));
		upperCaseLetterRangeCheckBox.setTitle(LocaleDictionary
				.getConstantValue(RegexBuilderConstants.UPPER_CASE_LETTER_RANGE_HELP_MESSAGE));
		wordBoundaryCheckBox.setTitle(LocaleDictionary.getConstantValue(RegexBuilderConstants.WORD_BOUNDARY_HELP_MESSAGE));
	...
	public void setEnableTextRangeTextFields(final boolean isEnabled) {
		if (!CollectionUtil.isEmpty(textRangeTextFields)) {
			for (TextField textField : textRangeTextFields) {
				...
				textField.setText(SystemConfigConstants.EMPTY_STRING);
			}
		}
	}
