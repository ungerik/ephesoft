...
import com.ephesoft.gxt.systemconfig.client.event.AddRegexBuilderFormEvent;
import com.ephesoft.gxt.systemconfig.client.event.RemoveRegexBuilderFormEvent;
import com.ephesoft.gxt.systemconfig.client.event.ResetRegexBuilderFormEvent;
import com.ephesoft.gxt.systemconfig.client.event.SelectRegexBuilderFormEvent;
import com.ephesoft.gxt.systemconfig.client.event.TestRegexBuilderFormEvent;
import com.ephesoft.gxt.systemconfig.client.event.regexbuilder.RegexEvent;
import com.ephesoft.gxt.systemconfig.client.event.regexbuilder.RegexEventHandler;
...
import com.ephesoft.gxt.systemconfig.client.regexbuilder.RegexEngine;
import com.ephesoft.gxt.systemconfig.client.regexbuilder.RegexFieldDetails;
import com.ephesoft.gxt.systemconfig.client.regexbuilder.RegexGroupDetails;
import com.ephesoft.gxt.systemconfig.client.regexbuilder.RegexQuantifierDetails;
import com.ephesoft.gxt.systemconfig.client.regexbuilder.DTO.RegexBuilderDetailsDTO;
import com.ephesoft.gxt.systemconfig.client.view.application.regexbuilder.RegexBuilderDetailView;
import com.ephesoft.gxt.systemconfig.client.view.application.regexbuilder.RegexBuilderMainView;
import com.ephesoft.gxt.systemconfig.client.view.application.regexbuilder.RegexFieldDetailView;
import com.ephesoft.gxt.systemconfig.client.view.application.regexbuilder.RegexGroupDetailView;
import com.ephesoft.gxt.systemconfig.client.view.application.regexbuilder.RegexQuantifierDetailView;
 ...
 */
public class RegexBuilderMainPresenter extends SystemConfigInlinePresenter<RegexBuilderMainView> {
	 ...
	 */
	public RegexBuilderMainPresenter(final SystemConfigController controller, final RegexBuilderMainView view) {
		...
		if (null != testEvent) {
			...
			if (StringUtil.isNullOrEmpty(regexPattern)) {
				...
				DialogUtil.showConfirmationDialog(LocaleDictionary.getConstantValue(SystemConfigConstants.ERROR_TITTLE),
						LocaleDictionary.getMessageValue(RegexBuilderConstants.REGEX_PATTERN_EMPTY_ERROR_MESSAGE), false,
						DialogIcon.ERROR);
			} else if (null == strToBeMatched) {

				DialogUtil.showConfirmationDialog(LocaleDictionary.getConstantValue(SystemConfigConstants.ERROR_TITTLE),
						LocaleDictionary.getMessageValue(RegexBuilderConstants.STRING_MATCHED_EMPTY_ERROR_MESSAGE), false,
						DialogIcon.ERROR);
			} else {
...
//				ScreenMaskUtility.unmaskScreen();
					...
					public void onSuccess(final List<String> matchedIndexList) {
						...
						if (!CollectionUtil.isEmpty(matchedIndexList)) {
							...
							DialogUtil.showMessageDialog(
									LocaleDictionary.getConstantValue(SystemConfigConstants.ERROR_TITLE), LocaleDictionary
	...
	public void onResetButtonClicked(ResetRegexBuilderFormEvent resetEvent) {
		if (null != resetEvent) {
			...
			view.getTestPanel().add(view.getMatchStringTextArea());
			view.getMatchStringTextArea().setVisible(true);
			view.getResultTextArea().setText(SystemConfigConstants.EMPTY_STRING);
			view.getMatchedHTML().setVisible(false);
	...
	private String getHTMLString(final List<String> matchedIndexList) {
		...
		String lastString = SystemConfigConstants.EMPTY_STRING;
		int lastEndIndex = 0;
		...
		if (null != selectEvent) {
			...
			if (StringUtil.isNullOrEmpty(regexPattern)) {
				DialogUtil.showConfirmationDialog(
						LocaleDictionary.getConstantValue(SystemConfigConstants.ERROR_TITTLE), LocaleDictionary
								.getMessageValue(RegexBuilderConstants.REGEX_PATTERN_EMPTY_ERROR_MESSAGE),
						false, DialogIcon.ERROR);
			} else if (view.getTextBoxToWhichRegexNeedToBeCopied() != null) {
				view.getTextBoxToWhichRegexNeedToBeCopied().setText(regexPattern);
				view.getDialogWindow().hide();
			}
		}
	}
	...
	public void resultTextAreaHandler() {
		if (view.getResultTextArea().getText().equals(SystemConfigConstants.EMPTY_STRING)) {
...
//					DialogUtil
//							.showMessageDialog(
//									LocaleDictionary.getConstantValue(SystemConfigConstants.INFO_TITLE),
...
//				DialogUtil.showMessageDialog(
//						LocaleDictionary.getConstantValue(SystemConfigConstants.ERROR_TITTLE), LocaleDictionary
//							.getMessageValue(RegexBuilderConstants.REGEX_PATTERN_INVALID), DialogIcon.ERROR);
//
//				showMatchStringTextArea();
//			}
//		}
