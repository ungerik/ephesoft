...
package com.ephesoft.gxt.systemconfig.client.presenter;
...
public class SystemConfigCompositePresenter<V extends SystemConfigCompositeView, T> extends SystemConfigInlinePresenter<V> {

	public SystemConfigCompositePresenter(SystemConfigController controller, V view) {
	...
	public final void layout(T selectionParameter) {
		...
		this.bind();
		SystemConfigInlineView<?> bottomPanelView = view.getBottomPanelView();
		SystemConfigInlineView<?> optionsPanelView = view.getTopPanelView();
		SystemConfigInlineView<?> centerPanelView = view.getCenterPanelView();
		...
		controller.setTopPanelView(optionsPanelView);
