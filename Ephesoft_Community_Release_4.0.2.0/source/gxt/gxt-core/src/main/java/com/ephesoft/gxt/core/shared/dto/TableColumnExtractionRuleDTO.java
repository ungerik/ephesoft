...
public class TableColumnExtractionRuleDTO implements IsSerializable, Selectable {
	...
	/**
	 * Reference {@link TableColumnInfoDTO} to the table column.
	 */
	private TableColumnInfoDTO tableColumnInfoDTO;
	...
	public TableColumnInfoDTO getTableColumnInfoDTO() {
		return tableColumnInfoDTO;
	}

	public void setTableColumnInfoDTO(TableColumnInfoDTO tableColumnInfoDTO) {
		this.tableColumnInfoDTO = tableColumnInfoDTO;
	}
