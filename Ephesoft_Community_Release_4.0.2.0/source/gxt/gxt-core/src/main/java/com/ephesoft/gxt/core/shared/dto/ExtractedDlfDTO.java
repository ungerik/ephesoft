...
public class ExtractedDlfDTO implements IsSerializable, Selectable {

	private String valueExtracted;
	...
	public String getValueExtracted() {
		return valueExtracted;
	}

	public void setValueExtracted(String valueExtracted) {
