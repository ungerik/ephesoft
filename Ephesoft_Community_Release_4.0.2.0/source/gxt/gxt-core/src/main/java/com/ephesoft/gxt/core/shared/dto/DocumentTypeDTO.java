...
public class DocumentTypeDTO implements IsSerializable, Selectable {

	private BatchClassDTO batchClass;

	private DocumentTypeMappingConfigDTO documentTypeMappingDTO;
	...
	private ConnectionsDTO connection;
	/**
	 */
	...
	public Collection<FieldTypeDTO> getFields() {
		...
		for (FieldTypeDTO fieldTypeDTO : fieldsMap.values()) {
			if (!(fieldTypeDTO.isDeleted()))
				fieldTypeDTOs.put(fieldTypeDTO.getIdentifier() + fieldTypeDTO.getName(), fieldTypeDTO);
		}
	...
	public void addFieldTypeDTO(FieldTypeDTO fieldTypeDTO) {
		fieldsMap.put("" + fieldTypeDTO.getIdentifier() + fieldTypeDTO.getName(), fieldTypeDTO);
	}
	 ...
	 */
	public ConnectionsDTO getDBExportConnection() {
		return documentTypeMappingDTO == null ? null : documentTypeMappingDTO.getDbExportConnection();
	}

	/**
	 * @return the connection
	 */
	public ConnectionsDTO getFuzzyConnection() {
		return documentTypeMappingDTO == null ? null : documentTypeMappingDTO.getFuzzyDBConnection();
	}

	/**
	 * @param connection the connection to set
	 */
	public void setDBExportConnection(ConnectionsDTO connection) {
		if (null == documentTypeMappingDTO) {
			documentTypeMappingDTO = new DocumentTypeMappingConfigDTO();
		}
		documentTypeMappingDTO.setDbExportConnection(connection);
	}

	/**
	 * @return the fuzzyDB mappings for each document.
	 */
	public FuzzyDBDTO getFuzzyDBDTO() {
		return fuzzyDBDTO;
	}

	/**
	 * sets the fuzzyDB mappings for each document.
	 * 
	 * @param fuzzyDBDTO
	 */
	public void setFuzzyDBDTO(FuzzyDBDTO fuzzyDBDTO) {
		this.fuzzyDBDTO = fuzzyDBDTO;
	}

	public DocumentTypeMappingConfigDTO getDocumentTypeMappingDTO() {
		return documentTypeMappingDTO;
	}

	public void setDocumentTypeMappingDTO(DocumentTypeMappingConfigDTO documentTypeMappingDTO) {
		this.documentTypeMappingDTO = documentTypeMappingDTO;
	}

	/**
	 * @param connection the connection to set
	 */
	public void setFuzzyConnection(ConnectionsDTO connection) {
		if (null == documentTypeMappingDTO) {
			documentTypeMappingDTO = new DocumentTypeMappingConfigDTO();
		}
		documentTypeMappingDTO.setFuzzyDBConnection(connection);
	}
}
