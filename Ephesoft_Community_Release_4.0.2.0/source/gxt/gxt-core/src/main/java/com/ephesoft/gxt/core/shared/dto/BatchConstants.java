...
public interface BatchConstants {
	...
	String RULE_CONFIGURATION_HTML = "<b>Table Rule Configuration</b>";
	...
	/**
	 * <code>ROLES_DISPLAY_NAME</code> a {@link String} constant for setting display name as roles.
	 */
	String ROLES_DISPLAY_NAME = "roles";

	/**
	 * <code>EMAIL_ACCOUNT_DISPLAY_NAME</code> a {@link String} constant for setting display name as email accounts.
	 */
	String EMAIL_ACCOUNT_DISPLAY_NAME = "email_accounts";

	/**
	 * <code>CMIS_PLUGIN_DISPLAY_NAME</code> a {@link String} constant for setting display name as CMIS plugin.
	 */
	String CMIS_PLUGIN_DISPLAY_NAME = "cmis_plugin";

	/**
	 * <code>SCRIPT_DISPLAY_NAME</code> a {@link String} constant for setting display name scripts.
	 */
	String SCRIPT_DISPLAY_NAME = "scripts";

	/**
	 * <code>BATCH_CLASS_DEFI_DISPLAY_NAME</code> a {@link String} constant for setting display name as batch class definition.
	 */
	String BATCH_CLASS_DEFI_DISPLAY_NAME = "batch_class_definition";

	/**
	 * <code>FOLDER_LIST_DISPLAY_NAME</code> a {@link String} constant for setting display name folder list.
	 */
	String FOLDER_LIST_DISPLAY_NAME = "folder_list";

	/**
	 * <code>BATCH_CLASS_MODULES_DISPLAY_NAME</code> a {@link String} constant for setting display name as batch class modules.
	 */
	String BATCH_CLASS_MODULES_DISPLAY_NAME = "batch_class_modules";

	/**
	 * <code>FOLDER_LIST</code> a {@link String} constant for setting key name as FolderList.
	 */
	String FOLDER_LIST = "FolderList";

	/**
	 * <code>BATCH_CLASS_MODULES</code> a {@link String} constant for setting key name as BatchClassModules.
	 */
	String BATCH_CLASS_MODULES = "BatchClassModules";

	/**
	 * <code>ROOT</code> a {@link String} constant for setting label as root.
	 */
	String ROOT = "root";

	/**
	 * <code>SPACE</code> a {@link String} constant for space.
	 */
	String SPACE = " ";

	/**
	 * Constant used to indicate equal while compare
	 */
	int IS_EQUAL = 0;
	...
	/**
	 * Constant for CMIS plugin properties checkbox label name.
	 */
	String CMIS_PROPERTIES_DISPLAY_NAME = "cmis_plugin_properties";

	/**
	 * Constant for CMIS plugin properties checkbox label key.
	 */
	String CMIS_PLUGIN_PROPERTIES = "cmisPluginProperties";

	/**
	 * Constant for CMIS mapping checkbox label name.
	 */
	String CMIS_MAPPING_DISPLAY_NAME = "cmis_mappings";

	/**
	 * Constant for CMIS mapping checkbox label key.
	 */
	String CMIS_MAPPING = "cmisMappings";

	String PASSWORD_DISPLAY_STRING = "********";

	String IMAP_SERVER_TYPE = "IMAP";

	String POP3_SERVER_TYPE = "POP3";
