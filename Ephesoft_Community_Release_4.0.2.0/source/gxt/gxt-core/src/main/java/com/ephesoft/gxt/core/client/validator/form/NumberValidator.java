...
public class NumberValidator extends AbstractValidator<String> {
	...
	public NumberValidator(final Class<?> isClass, final boolean isMandatory, final String inValidNumberMessage) {
		this(isClass, false, inValidNumberMessage,inValidNumberMessage);
	}

	public NumberValidator(final Class<?> isClass, final boolean isMandatory, final String inValidNumberMessage, String mandatoryErrorMessage){
	...
	public List<EditorError> validate(Editor<String> editor, String value) {
		...
		if (StringUtil.isNullOrEmpty(value) && isMandatory) {
			...
			isValid = ValidationUtil.isValidNumericalValue(value, isClass);
			if (!isValid) {
				return createError(new DefaultEditorError(editor, inValidNumberMessage, value));
			}
		}
		return null;
	}
