...
/**
 * Interface for the asynchronous services for the UI functioning.
 * 
 * @author Ephesoft
 * @version 3.0
 *
...
public interface DCMARemoteServiceAsync {
	...
	void validateRegExPattern(String regex, String value, AsyncCallback<Boolean> callback);
	 ...
	 */
	void initializeMetaData(AsyncCallback<InitializeMetaData> callback);

	public void getAllConnectionsDTO(final AsyncCallback<List<ConnectionsDTO>> callback);
	...
	public void validateRegexPattern(final Map<String, List<DirtyCell>> dirtyCellsMap,
			AsyncCallback<Map<String, List<DirtyCell>>> callback);
}
