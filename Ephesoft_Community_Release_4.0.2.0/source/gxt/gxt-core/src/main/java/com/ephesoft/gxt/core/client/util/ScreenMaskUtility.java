...
import com.ephesoft.gxt.core.client.ui.ScreenMask;
...
public class ScreenMaskUtility {
	...
	public static void maskScreen(String message) {
		com.ephesoft.gxt.core.client.ui.ScreenMaskUtility.maskScreen(message);
	}
	...
	public static void maskScreen() {
		com.ephesoft.gxt.core.client.ui.ScreenMaskUtility.maskScreen(LocaleDictionary.getConstantValue(CoreCommonConstants.PLEASE_WAIT));
	}

	public static void unmaskScreen() {
		com.ephesoft.gxt.core.client.ui.ScreenMaskUtility.unmaskScreen();
	}
