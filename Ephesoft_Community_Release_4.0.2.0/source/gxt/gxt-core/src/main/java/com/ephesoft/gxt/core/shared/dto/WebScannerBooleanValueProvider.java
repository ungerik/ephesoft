 ...
 */
public class WebScannerBooleanValueProvider<T extends WebScannerConfigurationDTO, V extends Comparable<Boolean>> implements
		ValueProvider<T, Boolean> {
	 ...
	 */
	public WebScannerBooleanValueProvider(String headerName, Class<V> className) {
		super();
				...
				for (WebScannerConfigurationDTO webScannerDTO : childList) {
					if (headerName.equalsIgnoreCase(webScannerDTO.getDescription())) {
						if (className == Boolean.class) {
							value = new Boolean(webScannerDTO.getValue());
						}
					}
				}
			}
	...
	@Override
	public void setValue(WebScannerConfigurationDTO object, Boolean value) {
		// TODO Auto-generated method stub
		WebScannerConfigurationDTO scannerDTO = (WebScannerConfigurationDTO) object;
		if (!headerName.equalsIgnoreCase(scannerDTO.getDescription())) {
			List<WebScannerConfigurationDTO> childList = (List<WebScannerConfigurationDTO>) scannerDTO.getChildren();
					...
					if (headerName.equalsIgnoreCase(webScannerDTO.getDescription())) {
						if (value != null) {
							if (value != null && value instanceof Boolean) {
								webScannerDTO.setValue(Boolean.toString((Boolean) value));
								// value = (V)(new Boolean(true));
							}
						} else {
