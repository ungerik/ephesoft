...
/**
 * Exception thrown whenever an exception is to be serialized at client side.
 * 
 * <p>
 * Error can cause due to several reasons like the call to a remote procedure fail: the network could be down; the HTTP server on the
 * other end might not be listening and others.
 * 
 * @author Ephesoft
 * @version 1.0.
 * 
