...
/**
 * This class <code>StickyDocumentDataDTO</code> holds the document data to be persisted when document type is changed on the validation
 * screen.
 * <p>
...
public class StickyDocumentDataDTO implements IsSerializable {
