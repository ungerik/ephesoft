...
public class UNCFolderConfig  implements IsSerializable {
	...
	private String batchClassPriority;
	...
	/**
	 * @return the batchClassDescription
	 */
	...
	/**
	 * @param batchClassDescription the batchClassDescription to set
	 */
	...
	/**
	 * @return the batchClassPriority
	 */
	public String getBatchClassPriority() {
		return batchClassPriority;
	}

	
	/**
	 * @param batchClassPriority the batchClassPriority to set
	 */
	public void setBatchClassPriority(String batchClassPriority) {
		this.batchClassPriority = batchClassPriority;
	}
}
