...
public class RegerPatternColumnConfigService implements ColumnConfigService<RegexPatternDTO> {
	...
	public RegerPatternColumnConfigService() {
		...
		regexPatternDescription.setHeader(LocaleDictionary.getConstantValue(CoreCommonConstants.REGEX_PATTERN_DESCRIPTION_COLUMN_HEADER));
