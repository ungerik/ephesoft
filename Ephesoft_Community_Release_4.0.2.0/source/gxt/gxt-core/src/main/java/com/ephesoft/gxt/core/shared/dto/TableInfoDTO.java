...
public class TableInfoDTO implements IsSerializable, Selectable {
	...
	private boolean removeInvalidRows;
	 ...
	 * 
	 * @return {@link Integer} the number of rows in the table
	 */
	 ...
	 * 
	 * @param numberOfRows {@link Integer} the number of rows to set
	 */
	...
	public boolean isRemoveInvalidRows() {
		return removeInvalidRows;
	}

	public void setRemoveInvalidRows(boolean isRemoveInvalidRows) {
		this.removeInvalidRows = isRemoveInvalidRows;
	}
	...
	/**
	 * Gets the <code>TableColumnInfoDTO</code> object for table column in this table which is not deleted with given identifier.
	 * 
	 * @param identifier {@link String} the identifier of the table column to be searched.
	 * @return {@link TableColumnInfoDTO} table column info DTO for the table column with the given in this table, returns
	 *         <code>null</code> if no such table column is found.
	 */
	public TableColumnInfoDTO getTableColumnInfoDTOByIdentifier(String identifier) {
		TableColumnInfoDTO tableColumnInfoDTO = null;
		for (TableColumnInfoDTO columnInfoDTO : columnInfoDTOs) {
			if (columnInfoDTO.getIdentifier().equalsIgnoreCase(identifier) && !columnInfoDTO.isDeleted()) {
				tableColumnInfoDTO = columnInfoDTO;
	...
	/**
	 * Gets the <code>TableColumnInfoDTO</code> object for table column in this table which is not deleted with given column name.
	 * 
	 * @param columnName {@link String} name of the table column to be searched.
	 * @return {@link TableColumnInfoDTO} table column info DTO for the table column with the given in this table, returns
	 *         <code>null</code> if no such table column is found.
	 */
	public TableColumnInfoDTO getTableColumnInfoDTOByColumnName(String columnName) {
		TableColumnInfoDTO tableColumnInfoDTO = null;
		if (!StringUtil.isNullOrEmpty(columnName)) {
			for (TableColumnInfoDTO columnInfoDTO : columnInfoDTOs) {
				if (columnInfoDTO.getColumnName().equalsIgnoreCase(columnName.trim()) && !columnInfoDTO.isDeleted()) {
					tableColumnInfoDTO = columnInfoDTO;
					break;
				}
			}
