 ...
 */
public class WebScannerStringValueProvider<T extends WebScannerConfigurationDTO, V extends Comparable<String>> implements
	 ...
	 */
	public WebScannerStringValueProvider(String headerName, Class<V> className) {
		super();
