...
public enum CategoryType {
	...
	UNCATEGORISED("Uncategorised"), GROUP_1("Group 1");
	...
	public static CategoryType getCategoryByName(String categoryName) {
		CategoryType associatedCategory = null;
		if (!StringUtil.isNullOrEmpty(categoryName)) {
			CategoryType[] categoryArray = CategoryType.values();
			for (CategoryType category : categoryArray) {
