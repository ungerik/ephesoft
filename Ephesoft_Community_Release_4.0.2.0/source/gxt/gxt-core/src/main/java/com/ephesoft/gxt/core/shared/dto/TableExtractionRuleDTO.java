 ...
 */
public class TableExtractionRuleDTO implements IsSerializable, Selectable {
	...
	private TableExtractionAPIModel extAPIModel;
	/**
	...
	public List<TableColumnExtractionRuleDTO> getTableColumnExtractionRuleDTOs() {
		List<TableColumnExtractionRuleDTO> newTableColumnExtractionRuleDTOs = new LinkedList<TableColumnExtractionRuleDTO>();
...
//			newTableColumnExtractionRuleDTOs = new LinkedList<TableColumnExtractionRuleDTO>();
	...
	public TableExtractionAPIModel getExtAPIModel() {
		return extAPIModel;
	}

	
	public void setExtAPIModel(TableExtractionAPIModel extAPIModel) {
		this.extAPIModel = extAPIModel;
	}
}
