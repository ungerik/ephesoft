...
public abstract class CustomGridViewConfig<T> implements GridViewConfig<T> {

	@Override
	public String getColStyle(T model, ValueProvider<? super T, ?> valueProvider, int rowIndex, int colIndex) {
		// TODO Auto-generated method stub
		if (isColumnInValid(model, valueProvider, rowIndex, colIndex)) {
			return CoreCommonConstant.CELL_ERROR_CSS;
		}
	...
	public abstract boolean isColumnInValid(T model, ValueProvider<? super T, ?> valueProvider, int rowIndex, int colIndex);
