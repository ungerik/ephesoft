...
/**
 * This interface provides Property Accessors for {@link WebScannerConfigurationDTO}.
 * 
 * @author Ephesoft
 * @version 1.0
 * 
 */
public interface WebScannerConfigurationProperties extends PropertyAccess<WebScannerConfigurationDTO> {

	public static WebScannerConfigurationProperties scannerProperties = GWT.create(WebScannerConfigurationProperties.class);

	/**
	 * @return {@link ModelKeyProvider}<{@link WebScannerConfigurationDTO}>
	 */
	ModelKeyProvider<WebScannerConfigurationDTO> identifier();

	/**
	 * @return {@link ValueProvider}<{@link WebScannerConfigurationDTO},{@link String}>
	 */
	...
	/**
	 * @return {@link ValueProvider}<{@link WebScannerConfigurationDTO},{@link Boolean}>
	 */
