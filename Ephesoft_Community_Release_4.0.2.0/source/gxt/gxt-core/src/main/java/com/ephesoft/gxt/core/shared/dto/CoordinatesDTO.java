...
public class CoordinatesDTO implements IsSerializable,Comparable {
	...
	public String toString(){
		return StringUtil.concatenate("(",this.x0,",",this.y0,")","(",this.x1,",",this.y1,")");
		
	}

	@Override
	public int compareTo(Object o) {
		CoordinatesDTO dto=(CoordinatesDTO)o;
		return (y0.intValue()-dto.y0.intValue());
	}
