...
public interface UploadBatchServiceAsync extends DCMARemoteServiceAsync {
	...
	void finishBatch(String currentBatchUploadFolder, String batchClassName, String batchDescription, String batchName,
			AsyncCallback<String> asyncCallback);

	/**
	 * API to get BatchClass id with it's description asynchronously.
	 * 
	 ...
	 */
	void getBatchClassName(boolean onBasisOfSorting, AsyncCallback<Map<String, String>> asyncCallback);

	/**
	 * API to get BatchClassFieldDTO By BatchClass Identifier asynchronously.
	 * 
	 * @param identifier {@link String}
	 * @param asyncCallback {@link AsyncCallback}<{@link List}<{@link BatchClassFieldDTO}>>
	 */
	 ...
	 * @param asyncCallback {@link AsyncCallback}<{@link Void}>
	 */
	 ...
	 * 
	 * @param asyncCallback {@link AsyncCallback}< {@link Map}<{@link String}, {@link BatchClassCloudConfigDTO}> >
	 */
	 ...
	 * 
	 * @param asyncCallBack {@link AsyncCallback}<{@link Long} >
	 */
	 ...
	 * 
	 * @param currentBatchUploadFolder {@link String}
	 * @param selectedFile {@link List}<{@link UploadBatchDTO}>
	 * @param asyncCallback {@link AsyncCallback}<{@link Void}>
	 */
	void deleteSelectedFiles(String currentBatchUploadFolder, List<UploadBatchDTO> selectedFile, AsyncCallback<Void> asyncCallback);
	 ...
	 * @param asyncCallback {@link AsyncCallback}<{@link String}>
	 */
	void deleteAllFiles(String currentBatchUploadFolder, AsyncCallback<String> asyncCallback);

	/**
	 * Serializes batch description to a serialized file.
	 * 
	 * @param folderName {@link String}
	 * @param batchDescription {@link String}
	 * @param asyncCallback {@link AsyncCallback}<{@link String}>
	 */
	void serializeBatchInstanceDescription(String folderName, String batchDescription, AsyncCallback<String> asyncCallback);
}
