...
public enum ValidateProperties implements PluginProperty {
	...
	/**
	 * Switch for insert table row script.
	 */
	INSERT_TABLE_ROW_SCRIPTING("validation.insert_table_row_script_switch"),
	/**
	 * Index field value separator.
	 */
	INDEX_FIELD_VALUE_SEPARATOR("validation.index_field_value_separator"),
	
	/**
	 * External application switch
	 */
	STICKY_INDEX_FIELD_SWITCH("validation.sticky_index_field_switch"),
	/**
	 * Table Extraction Sugestion Box Switch
	 */
	TABLE_EXTARCTION_SUGGESTION_BOX_SWITCH("validation.table_extraction_suggestion_box_switch");
	/**
	 * Property key.
	 */
	private String key;
