...
public abstract class ReviewValidateBasePresenter<T extends ReviewValidateBaseView> extends BasePresenter<ReviewValidateController, T> {

	protected ReviewValidateServiceAsync rpcService;

	public ReviewValidateBasePresenter(ReviewValidateController controller, T view) {
