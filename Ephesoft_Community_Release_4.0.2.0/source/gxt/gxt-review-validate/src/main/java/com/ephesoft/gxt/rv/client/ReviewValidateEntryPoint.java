...
public class ReviewValidateEntryPoint extends DCMAEntryPoint<ReviewValidateServiceAsync> {

	@Override
	public void onLoad() {
		ReviewValidateController controller = new ReviewValidateController(eventBus, rpcService);
		RootPanel.get().add(controller.createView());
	}

	@Override
	public ReviewValidateServiceAsync createRpcService() {
		return GWT.create(ReviewValidateService.class);
	}
