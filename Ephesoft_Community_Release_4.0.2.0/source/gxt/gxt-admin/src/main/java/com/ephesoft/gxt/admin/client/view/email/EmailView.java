...
/**
 * This View deals with Email Import.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.gxt.admin.client.view.email.EmailView
 */
public class EmailView extends BatchClassCompositeView<EmailPresenter> {

	/** The email grid view. */
	private final EmailGridView emailGridView;

	/** The email menu view. */
	public EmailMenuView emailMenuView;

	/**
	 * Instantiates a new email view.
	 */
	public EmailView() {
		emailGridView = new EmailGridView();
		emailMenuView = new EmailMenuView();
	}
	...
	public BatchClassInlineView<?> getListPanelView() {
		return emailGridView;
	}

	/**
	 * Gets the email grid view.
	 * 
	 * @return the emailGridView {@link EmailGridView}.
	 */
	public EmailGridView getEmailGridView() {
		return emailGridView;
	}

	/**
	 * Gets the email menu view.
	 * 
	 * @return the emailMenuView {@link EmailMenuView}.
	 */
	public EmailMenuView getEmailMenuView() {
		return emailMenuView;
	}
	@Override
	public void refresh() {
