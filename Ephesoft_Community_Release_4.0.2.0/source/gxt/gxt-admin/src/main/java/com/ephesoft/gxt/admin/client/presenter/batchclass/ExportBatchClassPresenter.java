 ...
 */
public class ExportBatchClassPresenter<V extends ExportBatchClassView> extends BasePresenter<BatchClassManagementController, V> {
	...
	public ExportBatchClassPresenter(final BatchClassManagementController controller, final V view) {
	...
	public void showBatchClassExportView() {
		...
		view.getDialogBox().setHeadingText(
				LocaleDictionary.getConstantValue(BatchClassConstants.EXPORT_BATCH_CLASS_LABEL));
	}
