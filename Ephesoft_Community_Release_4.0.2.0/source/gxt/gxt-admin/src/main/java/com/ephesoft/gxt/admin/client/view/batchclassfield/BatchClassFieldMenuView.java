...
import com.ephesoft.gxt.admin.client.presenter.batchclassfield.BatchClassFieldMenuPresenter;
...
/**
 * This View deals with Batch Class Field Menu.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.gxt.admin.client.view.batchclassfield.BatchClassFieldMenuView
 */
public class BatchClassFieldMenuView extends BatchClassInlineView<BatchClassFieldMenuPresenter> {

	/**
	 * The Interface Binder.
	 */
	interface Binder extends UiBinder<Widget, BatchClassFieldMenuView> {
	}
	...
	/**
	 * Instantiates a new batch class field menu view.
	 */
	public BatchClassFieldMenuView() {
		super();
	...
	private void addMenuItemActionEvents() {
		...
		deleteMenuItem.setScheduledCommand(new ScheduledCommand() {
			...
			@Override
			public void execute() {
				presenter.deleteBatchClassField();
			}
		});
