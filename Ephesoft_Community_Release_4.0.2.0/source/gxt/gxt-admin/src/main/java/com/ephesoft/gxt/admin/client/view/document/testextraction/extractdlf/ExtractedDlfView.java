...
public class ExtractedDlfView extends TestExtractionCompositeView<ExtractedDlfPresenter> {

	private ExtractdDlfGridView extractDlfGridView;

	public ExtractedDlfView() {
		extractDlfGridView = new ExtractdDlfGridView();
	}

	@Override
	public TestExtractionInlineView<?> getCenterPanelView() {
		return extractDlfGridView;
	}

	public ExtractdDlfGridView getExtractDlfGridView() {
		return extractDlfGridView;
	}
