...
import com.ephesoft.gxt.admin.client.presenter.regexbuilder.RegexBuilderMainPresenter;
 ...
 * 
 */
public class RegexBuilderMainView extends BatchClassInlineView<RegexBuilderMainPresenter> {
	...
	private boolean regexPatternValidStatus;
	...
	public RegexBuilderMainView() {
		...
		tabPanelBottomScroll.addStyleName("tabPanelBottomScrollPopUp");
	...
	private void addCSSStyles() {
		...
		resultLabel.addStyleName(BatchClassConstants.REGEX_BUILDER_LABEL_CSS);
		...
		strToBeMatchedLabel.addStyleName(BatchClassConstants.REGEX_BUILDER_LABEL_CSS);
	...
	public void resultTextAreaHandler() {
		...
		resultTextArea.addValueChangeHandler(new ValueChangeHandler<String>() {
	...
	public boolean isRegexPatternValidStatus() {
		return regexPatternValidStatus;
	}

	public void setRegexPatternValidStatus(boolean regexPatternValidStatus) {
		this.regexPatternValidStatus = regexPatternValidStatus;
	}
	
//	public void setResultTextAreaOnFormLoad(String previousPattern) {
//		resultTextArea.setText(previousPattern);
//		presenter.resultTextAreaHandler();
//	}
}
