...
public class PluginView extends BatchClassCompositeView<PluginPresenter> {

	private PluginDetailView pluginDetailView;
	private PluginDetailMenuView pluginDetailMenuView;

	public PluginView() {
		pluginDetailView = new PluginDetailView();
		pluginDetailMenuView = new PluginDetailMenuView();
	}

	@Override
	public BatchClassInlineView<?> getOptionsPanelView() {
		return pluginDetailMenuView;
	}
	...
	public PluginDetailMenuView getPluginDetailMenuView() {
		return pluginDetailMenuView;
	}
}
