 ...
 * @see BatchClassCompositePresenter
 * @see RegexBuilderView
 * @see RegexBuilderMainPresenter
 */

public class RegexBuilderPresenter extends BatchClassInlinePresenter<RegexBuilderView> {
	 ...
	 */
	public RegexBuilderPresenter(BatchClassManagementController controller, RegexBuilderView view) {
