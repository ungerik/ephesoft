...
import com.ephesoft.gxt.admin.client.presenter.scanner.WebScannerMenuPresenter;
...
/**
 * This View deals with Web Scanner Profile Menu.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.gxt.admin.client.view.scanner.WebScannerMenuView
 */
public class WebScannerMenuView extends BatchClassInlineView<WebScannerMenuPresenter> {

	/**
	 * The Interface Binder.
	 */
	interface Binder extends UiBinder<Widget, WebScannerMenuView> {
	}
	...
	/**
	 * Instantiates a new web scanner menu view.
	 */
	public WebScannerMenuView() {
		super();
	...
	private void addMenuItemActionEvents() {
		...
		deleteMenuItem.setScheduledCommand(new ScheduledCommand() {
			...
			@Override
			public void execute() {
				presenter.deleteCmisImportEntry();
			}
		});
	}
