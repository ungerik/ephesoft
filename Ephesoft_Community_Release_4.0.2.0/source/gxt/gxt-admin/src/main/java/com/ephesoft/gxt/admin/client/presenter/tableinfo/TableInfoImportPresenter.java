...
import com.ephesoft.gxt.admin.client.event.TableInfoImportEndEvent;
import com.ephesoft.gxt.admin.client.presenter.BatchClassInlinePresenter;
import com.ephesoft.gxt.admin.client.view.tableinfo.TableInfoImportView;
...
public class TableInfoImportPresenter extends BatchClassInlinePresenter<TableInfoImportView> {

	private BatchClassManagementServiceAsync rpcService;

	interface CustomEventBinder extends EventBinder<TableInfoImportPresenter> {
	}

	private static final CustomEventBinder eventBinder = GWT.create(CustomEventBinder.class);

	public TableInfoImportPresenter(BatchClassManagementController controller, TableInfoImportView view) {
	...
	@EventHandler
	public void handleTableInfoImportEndEvent(TableInfoImportEndEvent tableInfoImportEndEvent) {
		if (null != tableInfoImportEndEvent) {
			view.hideImportView();
		}
	}
