...
public class ModuleView extends BatchClassCompositeView<ModulePresenter>{

	private ModuleConfigureView moduleDetailView;
	private ModuleConfigureMenuView moduleDetailMenuView;
	
	public ModuleView(){
		moduleDetailView= new ModuleConfigureView();
		moduleDetailMenuView = new ModuleConfigureMenuView();
	}

	@Override
	public BatchClassInlineView<?> getOptionsPanelView() {
		return moduleDetailMenuView;
	}
	...
	public ModuleConfigureView getModuleDetailView(){
		return moduleDetailView;
	}
	public ModuleConfigureMenuView getModuleDetailMenuView(){
		return moduleDetailMenuView;
	}
	@Override
	public void refresh() {
