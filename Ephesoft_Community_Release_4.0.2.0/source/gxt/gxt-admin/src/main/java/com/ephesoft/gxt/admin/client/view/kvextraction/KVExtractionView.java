...
public class KVExtractionView extends BatchClassCompositeView<KVExtractionPresenter>{

	KVExtractionMenuView kvExtractionMenuView;
	KVExtractionGridView kvExtractionGridView;
	public KVExtractionView() {
		kvExtractionGridView=new KVExtractionGridView();
		kvExtractionMenuView = new KVExtractionMenuView();
	}

	@Override
	public BatchClassInlineView<?> getOptionsPanelView() {
		return kvExtractionMenuView;
	}
	...
	public BatchClassInlineView<?> getListPanelView() {
		return kvExtractionGridView;
	}

	public KVExtractionMenuView getMenuView() {
		return kvExtractionMenuView;
	}

	public KVExtractionGridView getGridView() {
		return kvExtractionGridView;
	}
	@Override
	public void refresh() {
