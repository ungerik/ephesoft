...
/**
 * This presenter deals with Email Import.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.gxt.admin.client.presenter.email.EmailPresenter
 */
public class EmailPresenter extends BatchClassCompositePresenter<EmailView, BatchClassDTO> {

	/** The email grid presenter. */
	private final EmailGridPresenter emailGridPresenter;

	/** The email menu presenter. */
	private final EmailMenuPresenter emailMenuPresenter;

	/**
	 * Instantiates a new email presenter.
	 * 
	 * @param controller the controller {@link BatchClassManagementController}
	 * @param view the view {@link EmailView}
	 */
	public EmailPresenter(final BatchClassManagementController controller, final EmailView view) {
		super(controller, view);
		emailGridPresenter = new EmailGridPresenter(controller, view.getEmailGridView());
		emailMenuPresenter = new EmailMenuPresenter(controller, view.getEmailMenuView());
	}
	...
	/**
	 * Gets the email grid presenter.
	 * 
	 * @return the email grid presenter {@link EmailGridPresenter}
	 */
	public EmailGridPresenter getEmailGridPresenter() {
		return emailGridPresenter;
	}

	/**
	 * Gets the email menu presenter.
	 * 
	 * @return the email menu presenter {@link EmailMenuPresenter}
	 */
	public EmailMenuPresenter getEmailMenuPresenter() {
		return emailMenuPresenter;
	}
	...
	public boolean isValid() {
		return emailGridPresenter.isValid();
	}
