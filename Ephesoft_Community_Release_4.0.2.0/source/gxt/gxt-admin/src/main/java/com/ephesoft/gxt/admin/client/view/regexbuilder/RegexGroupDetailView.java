...
import com.ephesoft.gxt.admin.client.presenter.regexbuilder.RegexGroupDetailPresenter;
 ...
 */
public class RegexGroupDetailView extends BatchClassInlineView<RegexGroupDetailPresenter> {
	...
	public RegexGroupDetailView() {
		...
		regexGroupContainer.setHeadingText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.REGEX_BUILDER_GROUP)));
		regexGroupContainer.addStyleName("panelHeader");
		// regexGroupHeading.setText(LocaleDictionary.getConstantValue(RegexBuilderConstants.REGEX_BUILDER_GROUP));
		...
		applyQuantifierToGroupLabel.setText(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.APPLY_QUANTIFIER_TO_ENTIRE_REGEX));
	...
	private void addCSSStyles() {
		...
		// Add CSS for Label.
		caseInsensetiveLabel.addStyleName(BatchClassConstants.REGEX_BUILDER_LABEL_CSS);
		startGroupLabel.addStyleName(BatchClassConstants.REGEX_BUILDER_LABEL_CSS);
		endGroupLabel.addStyleName(BatchClassConstants.REGEX_BUILDER_LABEL_CSS);
		captureGroupLabel.addStyleName(BatchClassConstants.REGEX_BUILDER_LABEL_CSS);
		nonCaptureGroupLabel.addStyleName(BatchClassConstants.REGEX_BUILDER_LABEL_CSS);
		applyQuantifierToGroupLabel.addStyleName(BatchClassConstants.REGEX_BUILDER_LABEL_CSS);

		caseInsensetiveLabel.addStyleName(BatchClassConstants.LABEL_TEXT_CSS);
		startGroupLabel.addStyleName(BatchClassConstants.LABEL_TEXT_CSS);
		endGroupLabel.addStyleName(BatchClassConstants.LABEL_TEXT_CSS);
		captureGroupLabel.addStyleName(BatchClassConstants.LABEL_TEXT_CSS);
		nonCaptureGroupLabel.addStyleName(BatchClassConstants.LABEL_TEXT_CSS);
		applyQuantifierToGroupLabel.addStyleName(BatchClassConstants.LABEL_TEXT_CSS);
	...
	private void addHelpMessages() {
		...
		caseInsensetiveCheckBox.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.CASE_INSENSETIVE_HELP_MESSAGE));
		startGroupCheckBox.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.START_GROUP_HELP_MESSAGE));
		endGroupCheckBox.setTitle(LocaleDictionary
				.getConstantValue(RegexBuilderConstants.END_GROUP_HELP_MESSAGE));
		captureGroupCheckBox.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.CAPTURE_GROUP_HELP_MESSAGE));
		nonCaptureGroupCheckBox.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.NON_CAPTURE_GROUP_HELP_MESSAGE));
		applyQuantifierToGroupCheckBox.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.APPLY_QUANTIFIER_TO_ENTIRE_REGEX_HELP_MESSAGE));
