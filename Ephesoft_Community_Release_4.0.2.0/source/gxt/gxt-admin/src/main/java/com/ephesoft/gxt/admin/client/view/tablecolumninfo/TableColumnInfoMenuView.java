...
import com.ephesoft.gxt.admin.client.presenter.tablecolumninfo.TableColumnInfoMenuPresenter;
...
/**
 * This View deals with Table Column Info Menu.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.gxt.admin.client.view.tablecolumninfo.TableColumnInfoMenuView
 */
public class TableColumnInfoMenuView extends BatchClassInlineView<TableColumnInfoMenuPresenter> {

	/**
	 * The Interface Binder.
	 */
	interface Binder extends UiBinder<Widget, TableColumnInfoMenuView> {
	}
	...
	/**
	 * Instantiates a new table column info menu view.
	 */
	public TableColumnInfoMenuView() {
		super();
