...
import com.ephesoft.gxt.admin.client.presenter.regexbuilder.RegexQuantifierDetailPresenter;
 ...
 */
public class RegexQuantifierDetailView extends BatchClassInlineView<RegexQuantifierDetailPresenter> {
	...
	public RegexQuantifierDetailView() {
		...
		asFewAsPossibleLabel.setText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.AS_FEW_AS_POSSIBLE)));
		regexQuantifierContainer.setHeadingText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.REGEX_QUANTIFIER)));
		exactlyOneTimesRadioButton.setText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.EXACTLY_ONE_TIME)));
		betweenZeroAndOneTimesRadioButton.setText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.BETWEEN_0_AND_1_TIME)));
		anyNoOfTimesRadioButton.setText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.ANY_NO_OF_TIMES)));
		oneOrMoreTimesRadioButton.setText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.ONE_OR_MORE_TIMES)));
		exactlyNoOfTimesRadioButton.setText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.EXACTLY_NO_OF_TIMES)));
		betweenMinAndMaxTimesRadioButton.setText(StringUtil.concatenate(BatchClassConstants.SPACE, LocaleDictionary
				.getConstantValue(RegexBuilderConstants.BETWEEN_MIN_AND_MAX_TIME)));
	...
	private void addHelpMessages() {
		asFewAsPossibleCheckBox.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.AS_FEW_AS_POSSIBLE_HELP_MESSAGE));
		exactlyOneTimesRadioButton.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.EXACTLY_ONE_TIME_HELP_MESSAGE));

		betweenZeroAndOneTimesRadioButton.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.BETWEEN_0_OR_1_TIME_HELP_MESSAGE));
		anyNoOfTimesRadioButton.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.ANY_NO_OF_TIMES_HELP_MESSAGE));
		oneOrMoreTimesRadioButton.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.ONE_OR_MORE_TIME_HELP_MESSAGE));
		exactlyNoOfTimesRadioButton.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.REPEAT_N_TIMES_HELP_MESSAGE));
		betweenMinAndMaxTimesRadioButton.setTitle(LocaleDictionary.getConstantValue(
				RegexBuilderConstants.BETWEEN_MAX_AND_MIN_TIME_HELP_MESSAGE));
	...
	private void setVisibleNoOfTimesTextBox(final boolean isVisible) {
		...
		txtNoOfTimes.setText(BatchClassConstants.EMPTY_STRING);
