...
public class AdvancedTableColumnExtractionImageOverlayEvent extends GenericEvent {

	private Coordinates coordinates;

	public AdvancedTableColumnExtractionImageOverlayEvent(int x0, int x1, int y0, int y1) {
