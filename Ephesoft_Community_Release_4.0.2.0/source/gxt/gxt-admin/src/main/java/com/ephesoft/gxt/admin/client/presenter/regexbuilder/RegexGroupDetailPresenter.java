 ...
 */
public class RegexGroupDetailPresenter extends BatchClassInlinePresenter<RegexGroupDetailView> {
	 ...
	 */
	public RegexGroupDetailPresenter(final BatchClassManagementController controller, final RegexGroupDetailView view) {
