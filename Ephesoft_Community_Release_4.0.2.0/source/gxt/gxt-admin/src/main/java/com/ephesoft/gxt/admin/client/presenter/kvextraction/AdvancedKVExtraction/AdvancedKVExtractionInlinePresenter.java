...
public abstract class AdvancedKVExtractionInlinePresenter<V extends AdvancedKVExtractionInlineView> extends
		BasePresenter<BatchClassManagementController, V> {

	protected BatchClassManagementServiceAsync rpcService;

	public AdvancedKVExtractionInlinePresenter(BatchClassManagementController controller, V view) {
