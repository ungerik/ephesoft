...
import com.ephesoft.gxt.admin.client.presenter.regexbuilder.RegexBuilderToolBarPresenter;
 ...
 */
public class RegexBuilderToolBar extends BatchClassInlineView<RegexBuilderToolBarPresenter> {
	...
	public RegexBuilderToolBar() {
		...
		selectRegexButton.setEnabled(false);
	}
	...
	private void intializeMenuItems() {
		...
		removeMenuItem = new CustomMenuItem(new SafeHtml() {
			...
			public String asString() {
				...
				return LocaleDictionary.getConstantValue(BatchClassConstants.REMOVE_REGEX_BUTTON);
			}
		});
		...
		resetMenuItem = new CustomMenuItem(new SafeHtml() {
			...
			public String asString() {
				...
				return LocaleDictionary.getConstantValue(BatchClassConstants.RESET_REGEX_BUTTON);
			}
		});
		...
		addMenuItem = new CustomMenuItem(new SafeHtml() {
			...
			public String asString() {
				...
				return LocaleDictionary.getConstantValue(BatchClassConstants.ADD_REGEX_BUTTON);
			}
		});
