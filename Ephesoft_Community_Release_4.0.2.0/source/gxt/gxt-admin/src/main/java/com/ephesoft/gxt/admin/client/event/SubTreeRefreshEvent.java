...
public class SubTreeRefreshEvent extends GenericEvent{
	
	public static class ModuleSubTreeRefreshEvent extends GenericEvent {

		private BatchClassDTO batchClass;

		public ModuleSubTreeRefreshEvent(final BatchClassDTO batchClass) {
	...
	public static class PluginSubTreeRefreshEvent extends GenericEvent {

		private BatchClassModuleDTO batchClassModule;

		public PluginSubTreeRefreshEvent(final BatchClassModuleDTO batchClassModule) {
