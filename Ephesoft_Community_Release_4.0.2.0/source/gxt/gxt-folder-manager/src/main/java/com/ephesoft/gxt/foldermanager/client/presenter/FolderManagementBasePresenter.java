...
public abstract class FolderManagementBasePresenter<V extends View> extends BasePresenter<FolderManagementController, V> {

	protected FolderManagerServiceAsync rpcService;

	public FolderManagementBasePresenter(final FolderManagementController controller, final V view) {
