...
public class CleanupComponent {
	 ...
	 */
	public static void execute(final String sFolderToBeCleaned) throws DCMAApplicationException {
		...
		if (deleteFiles) {
			...
			if (!fFolderToBeCleaned.exists()) {
				...
				throw new DCMABusinessException("Unable to delete Folder : " + fFolderToBeCleaned);
			}
		}
	}
		...
		if (fileToBeDeleted.exists()) {
			...
			if (deleteSuccess) {
				...
				if (!fileToBeDeleted.exists()) {
					...
					throw new DCMABusinessException("Unable to delete the file. File name : " + file);
				}
			}
		} else {
