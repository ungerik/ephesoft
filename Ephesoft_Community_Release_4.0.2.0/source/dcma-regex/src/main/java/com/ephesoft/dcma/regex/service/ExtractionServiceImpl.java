...
public class ExtractionServiceImpl implements ExtractionService {
	...
	@Override
	public void extractDocumentFieldsForExtraction(final String batchClassID, final String folderPath, Batch batch)
			throws DCMAApplicationException {
		try {
			LOGGER.info("Extracting document level fields...");
			extraction.extractFieldsTestExtractionAPI(batchClassID, folderPath, batch);
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
