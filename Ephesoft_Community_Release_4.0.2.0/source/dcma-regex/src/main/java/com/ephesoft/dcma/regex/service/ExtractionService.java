...
public interface ExtractionService {
	...
	List<DocField> extractDocumentFieldsFromHOCR(String batchClassID, String docTypeName, HocrPages hocrPages)
			throws DCMAException;
	/**
	 * Performs regex extraction on the input image provided 
	 * 
	 * @param batchClassID
	 * @param folderPath
	 * @param batch
	 ...
	 */
	void extractDocumentFieldsForExtraction(String batchClassID, String folderPath, Batch batch) throws DCMAApplicationException;
