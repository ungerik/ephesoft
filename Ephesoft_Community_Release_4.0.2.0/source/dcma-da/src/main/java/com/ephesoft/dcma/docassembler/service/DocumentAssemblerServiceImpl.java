...
public class DocumentAssemblerServiceImpl implements DocumentAssemblerService {
	...
	@Override
	public void reCreateDocumentXml(final String batchInstanceIdentifer, final String batchClassIdentifier,
			final List<Document> documentList) throws DCMAApplicationException {

		if (documentList != null && !documentList.isEmpty()) {

			LOGGER.info(EphesoftStringUtil.concatenate("Entering method reCreateDocumentXml for ", batchInstanceIdentifer));
			docAssembler.reCreateDocumentXml(batchInstanceIdentifer, batchClassIdentifier, documentList);
			LOGGER.info(EphesoftStringUtil.concatenate("Documents Reclassified successully. Exiting method reCreateDocumentXml for ",
					batchInstanceIdentifer));
