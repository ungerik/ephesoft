...
public class SearchablePdfClassification implements DocumentClassification {
	...
	public final void processUnclassifiedPages(final DocumentAssembler documentAssembler, final String batchInstanceID,
		...
		searchablePdfPageProcess.setPluginPropertiesService(pluginPropertiesService);
		...
		searchablePdfPageProcess.setPropertyMap(propertyMap);
	...
	public void processDocumentTypes(DocumentAssembler documentAssembler, String batchInstanceIdentifier, String batchClassIdentifer,
		...
		searchablePdfPageProcess.setBatchInstanceID(batchInstanceIdentifier);
		searchablePdfPageProcess.setBatchSchemaService(documentAssembler.getBatchSchemaService());
		searchablePdfPageProcess.reClassifyDocuments(documentList);
