 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.dao.BatchClassCmisConfigDaoImpl
 */
public interface BatchClassCmisConfigDao extends CacheableDao<BatchClassCmisConfiguration> {
	...
	/**
	 * An api to fetch all BatchClassCmisConfiguration by batch class identifier starting at firstIndex and maxResults is the total
	 * number of records.
	 * 
