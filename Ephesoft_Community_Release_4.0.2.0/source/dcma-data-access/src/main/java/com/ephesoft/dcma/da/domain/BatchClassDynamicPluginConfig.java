...
public class BatchClassDynamicPluginConfig extends AbstractChangeableEntity implements Cloneable {
	...
	@JoinColumn(name = "parent_id")
	private List<BatchClassDynamicPluginConfig> children = new ArrayList<BatchClassDynamicPluginConfig>();
	...
	public void setChildren(List<BatchClassDynamicPluginConfig> children) {
		if (!CollectionUtil.isEmpty(children)) {
			...
			for (final BatchClassDynamicPluginConfig config : children) {
				if (null != config) {
