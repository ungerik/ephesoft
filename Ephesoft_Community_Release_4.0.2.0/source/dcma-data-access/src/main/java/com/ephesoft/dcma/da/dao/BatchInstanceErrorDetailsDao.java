...
/**
 * A Dao representing batch_instance_error_details table in database.
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.core.dao.Dao
 */
public interface BatchInstanceErrorDetailsDao extends Dao<BatchInstanceErrorDetails> {
	 ...
	 */
	BatchInstanceErrorDetails getBatchInstancesErrorDetailsByIdentifier(final String identifier);
}
