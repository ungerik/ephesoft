...
/**
 * Dao implementation of ReportsFolderDao
 * 
 * @author Ephesoft
 * 
 */
@Repository
public class ReportsFolderDaoImpl extends HibernateDao<ReportsFolder> implements ReportsFolderDao {
	...
	@Override
	public List<ReportsFolder> getAllFolders(final int FolderIndex, final int maxResult) {
		final DetachedCriteria criteria = criteria();
		return find(criteria, FolderIndex, maxResult);
	}
