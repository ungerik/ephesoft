...
public interface BatchClassModuleService {
	...
	/**
	 * Gets the order number of workflow for a particular batch class passed as a parameter.
	 * 
	 * @param batchClassIdentifier identifier of batch class.
	 * @param workflowName workflow name for which order number is to be determine.
	 * @return int: order number of respective workflow.
	 */
	int getBatchClassWorkflowOrderNumber(String batchClassIdentifier, String workflowName);

	/**
	 * Gets id of the module by workflow name of a batch class.
	 * 
	 * @param batchClassIdentifier {@link String}
	 * @param workflowName {@link String}
	 * @return long
	 */
	long getModuleIdByWorkflowName(String batchClassIdentifier, String workflowName);

	/**
	 * Get module description by its module id.
	 * 
	 * @param batchClass {@link BatchClass}
	 * @param moduleId long
	 * @return {@link String}
	 */
	String getModuleNameByModuleId(BatchClass batchClass, long moduleId);
}
