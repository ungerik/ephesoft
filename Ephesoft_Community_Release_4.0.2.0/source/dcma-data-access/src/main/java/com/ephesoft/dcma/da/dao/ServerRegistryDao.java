...
/**
 * Interface to fetch Server Registry.
 * @author Ephesoft
 * 
...
public interface ServerRegistryDao extends Dao<ServerRegistry> {
	 ...
	 * 
	 * @param {@link Serializable} identifier
	 * @return {@link ServerRegistry} ServerRegistry
	 */
	 ...
	 * 
	 * @param {@link ServerRegistry} serverRegistry
	 */
	...
	/**
	 * Returns the list of server registry for all active servers.
	 * 
	 * @return {@link List}<{@link ServerRegistry}> list of server registry of all active servers
	 */
	List<ServerRegistry> getActiveServers();

	/**
	 * Returns the list of server registry for all active License servers.
	 * 
	 * @return {@link List}<{@link ServerRegistry}> of server registry of all active servers
	 */
	List<ServerRegistry> getActiveLicenseServers();

	/**
	 * Returns the list of server registry for all active FolderMoniter servers.
	 * 
	 * @return {@link List}<{@link ServerRegistry}> of server registry domain object of all active servers
	 */
