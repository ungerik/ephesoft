...
public interface BatchInstanceGroupsDao {
	...
	/**
	 * API for deleting the finished batch instances using the given id in batch_instance_groups table.
	 * 
	 * @param batchInstanceIdentifier {@link String}
	 */
	void deleteBatchInstanceInGroups(String batchInstanceIdentifier);
