...
public interface FieldTypeService {
	 ...
	 * @param docTypeName {@link String}
	 * @param batchInstanceIdentifier {@link String}
	 * @param isKVExtraction {@link boolean}
	 * @return {@link List}<{@link FieldType}>
	 */
	...
	/**
	 * To get FieldType using identifier.
	 * 
	 * @param identifier {@link String}
	 * @return fieldType {@link FieldType}
	 */
	FieldType getFieldTypeByIdentifer(String identifier);

	/**
	 * This API is used to merge the Field type.
	 * 
	 * @param fieldType {@link FieldType}
	 * @return {@link FieldType}new Field type is returned.
	 */
	FieldType mergeFieldType(FieldType fieldType);

	/**
	 * Api to get loaded FieldType using identifier.
	 * 
	 * @param identifier {@link String}
	 * @return fieldType {@link FieldType}
	 */
	FieldType getLoadedFieldTypeByIdentifer(String identifier);
}
