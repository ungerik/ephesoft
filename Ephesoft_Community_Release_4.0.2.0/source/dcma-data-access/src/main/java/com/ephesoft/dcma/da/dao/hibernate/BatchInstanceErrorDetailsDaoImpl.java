...
/**
 * Implementation of a Dao representing batch_instance_error_details table in database.
 * 
 * @author Ephesoft
 * @version 3.0
 * @see com.ephesoft.dcma.core.dao.hibernate.HibernateDao
 */
@Repository
public class BatchInstanceErrorDetailsDaoImpl extends HibernateDao<BatchInstanceErrorDetails> implements BatchInstanceErrorDetailsDao {
