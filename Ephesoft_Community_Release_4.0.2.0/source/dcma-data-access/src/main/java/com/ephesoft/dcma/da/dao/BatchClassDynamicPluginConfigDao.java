...
public interface BatchClassDynamicPluginConfigDao extends CacheableDao<BatchClassDynamicPluginConfig> {
	...
	/**
	 * This method gets the dynamic plugin properties for batch class.
	 * 
	 * @param batchClassIdentifier {@link String}
	 * @param pluginName {@link String}
	 * @return {@link List}<{@link BatchClassDynamicPluginConfig} > the dynamic plugin properties for batch class
	 */
	List<BatchClassDynamicPluginConfig> getDynamicPluginPropertiesForBatchClass(String batchClassIdentifier, String pluginName);

	/**
	 * This method gets the all dynamic plugin properties for batch instance.
	 * 
	 * @param batchInstanceIdentifier {@link String}
	 * @return {@link List}<{@link BatchClassDynamicPluginConfig}> the all dynamic plugin properties for batch instance
	 */
	List<BatchClassDynamicPluginConfig> getAllDynamicPluginPropertiesForBatchInstance(String batchInstanceIdentifier);

	/**
	 * This method gets the all dynamic plugin properties for batch class.
	 * 
	 * @param batchClassIdentifier {@link String}
	 * @return {@link List}<{@link BatchClassDynamicPluginConfig}> the all dynamic plugin properties for batch class
	 */
