...
public class AdvancedKVExtraction extends AbstractChangeableEntity implements Serializable {
	...
	/**
	 * Mapping to Advanced KV Extraction Detail
	 */
	@OneToMany
	...
	private List<AdvancedKVExtractionDetail> advancedKVExtractionDetails;
	...
	public List<AdvancedKVExtractionDetail> getAdvancedKVExtractionDetail() {
		return advancedKVExtractionDetails;
	}

	public void setAdvancedKVExtractionDetail(List<AdvancedKVExtractionDetail> advancedKVExtractionDetail) {
		this.advancedKVExtractionDetails = advancedKVExtractionDetail;
	}

	public void removeAdvDetailByIdentifier(String moduleIdentifier) {
		List<AdvancedKVExtractionDetail> advKVExtractionDetails = new ArrayList<AdvancedKVExtractionDetail>(
				this.advancedKVExtractionDetails);
		for (AdvancedKVExtractionDetail advKVExtractionDetail : advKVExtractionDetails) {
			if (moduleIdentifier.equals(String.valueOf(advKVExtractionDetail.getId()))) {
				this.advancedKVExtractionDetails.remove(advKVExtractionDetail);
				break;
			}
		}
	}

	public void addModule(AdvancedKVExtractionDetail advKVExtractionDetail) {
		advancedKVExtractionDetails =advancedKVExtractionDetails!=null?advancedKVExtractionDetails:new ArrayList<AdvancedKVExtractionDetail>();
		this.advancedKVExtractionDetails.add(advKVExtractionDetail);
	}

	public AdvancedKVExtractionDetail getAdvKVDetailById(long identifier) {
		AdvancedKVExtractionDetail advKVDetail1 = null;
		if (!(this.advancedKVExtractionDetails == null || this.advancedKVExtractionDetails.isEmpty())) {
			for (AdvancedKVExtractionDetail advKVDetail : this.advancedKVExtractionDetails) {
				if (advKVDetail.getId() == identifier) {
					advKVDetail1 = advKVDetail;
					break;
				}
			}
		}
