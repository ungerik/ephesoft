...
/**
 * A Dao representing table_rule table in database.
 * 
 * @author Ephesoft
 * @version 1.0
 */
public interface TableRuleInfoDao extends CacheableDao<TableRuleInfo> {

	/**
	 * API to fetch TableRulesInfo by TableInfo
	 * 
	 * @param tableInfo {@link TableInfo}
	 * @return {@link List}<{@link TableRuleInfo}>
	 */

	List<TableRuleInfo> getTableRulesInfoByTableInfo(TableInfo tableInfo);
	 ...
	 * @return {@link List}<{@link TableRuleInfo}>table rule info list
	 */

	List<TableRuleInfo> getTableRulesInfo(String batchClassIdentifer, String docTypeName, String tableName);

	/**
	 * API to insert the TableRuleInfo object.
	 * 
	 * @param tableRuleInfo {@link TableRuleInfo}
	 */

	void insertTableRulesInfo(TableRuleInfo tableRuleInfo);
	...
	void updateTableRulesInfo(TableRuleInfo tableRuleInfo);
	...
	void removeTableRulesInfo(TableRuleInfo tableRuleInfo);
	...
	void updateTableColumnsInfo(List<TableRuleInfo> listTableRuleInfos, List<TableRuleInfo> listTableRuleToBeDeleted);
	...
	List<TableRuleInfo> getAllTableRules();
