...
@MappedSuperclass
public abstract class DBExportOptionalParameters extends AbstractEntity {

	private static final long serialVersionUID = 1L;

	@Column(name = "parameter", nullable = true, insertable = true, updatable = true)
	...
	/**
	 * For Future Scope , Batch Class Fields to different columns;
	 */
