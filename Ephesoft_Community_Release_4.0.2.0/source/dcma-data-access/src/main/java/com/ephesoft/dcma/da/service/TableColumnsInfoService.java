...
public interface TableColumnsInfoService {
	...
	/**
	 * An api to fetch all TableColumnsInfo by Table info..
	 * 
	 ...
	 * @return {@link List}<{@link TableColumnsInfo}>
	 */
	List<TableColumnsInfo> getTableColumnsInfo(String batchClassIdentifer, String docTypeName, String tableName);
