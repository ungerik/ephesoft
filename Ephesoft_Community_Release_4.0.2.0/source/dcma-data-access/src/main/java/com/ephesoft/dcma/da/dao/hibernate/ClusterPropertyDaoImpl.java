...
/**
 * Implementation of ClusterPropertyDao.
 * @author ganeshvyas
 *
 */
@Repository
public class ClusterPropertyDaoImpl extends HibernateDao<ClusterProperty> implements ClusterPropertyDao {

	@Override
	public List<ClusterProperty> getAllPropertyList() {
	...
	@Override
	public void saveOrUpdateProperty(ClusterProperty property) {
		saveOrUpdate(property);

	}

	@Override
	public void removeProperty(ClusterProperty property) {
		remove(property);
	}

	@Override
	public void createClusterProperty(ClusterProperty clusterProperty) {
		create(clusterProperty);
