...
/**
 * The interface <code>RegexPatternService</code> is a database service to read/edit RegexPattern data required by Regex Pool Service .
 * 
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.service.RegexPatternServiceImpl
 */
public interface RegexPatternService {
	...
	/**
	 * Gets RegexPatterns by regexGroupId.
	 * 
	 * @param identifier {@link Long}
	 * @return {@link List}<{@link RegexPattern}> null if action was unsuccessful.
	 */
	List<RegexPattern> getRegexPatternsByRegexGroupId(Long identifier);

	/**
	 * Inserts Regex pattern object.
	 * 
	 * @param regexPattern {@link RegexPattern}
	 * @return {@link Boolean} true if insertion was successful.
	 */
	boolean insertRegexPattern(RegexPattern regexPattern);

	/**
	 * Updates Regex pattern object.
	 * 
	 * @param regexPattern {@link RegexPattern}
	 * @return {@link Boolean} true if update was successful.
	 */
	boolean updateRegexPattern(RegexPattern regexPattern);

	/**
	 * Removes Regex pattern object.
	 * 
	 * @param identifier {@link Long}
	 * @return {@link Boolean} true if removal was successful.
	 */
	boolean removeRegexPattern(Long identifier);
