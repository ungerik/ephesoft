 ...
 * @author Ephesoft
 * @version 1.0
 * @see com.ephesoft.dcma.da.service.TableRuleInfoServiceImpl
 */
public interface TableRuleInfoService {
	 ...
	 */
	void updateTableRulesInfo(List<TableRuleInfo> listTableRuleInfos, List<TableRuleInfo> listTableRuleToBeDeleted);
