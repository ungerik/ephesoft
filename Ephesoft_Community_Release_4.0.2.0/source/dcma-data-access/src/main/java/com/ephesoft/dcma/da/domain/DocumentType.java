...
public class DocumentType extends AbstractChangeableEntity implements Serializable {
	...
	@Column(name = "second_page_project_file_name")
	private String secondPageProjectFileName;

	@Column(name = "third_page_project_file_name")
	private String thirdPageProjectFileName;

	@Column(name = "fourth_page_project_file_name")
	...
	private DocumentTypeMappingConfig documentTypeMappingConfig;
	...
	/**
	 * @return the dbExportConnection
	 */
	public Connections getDbExportConnection() {
		return documentTypeMappingConfig == null ? null : documentTypeMappingConfig.getDatabaseExportConnections();
	}

	public void setDocumentTypeConfigId(long id) {
		if (null != documentTypeMappingConfig) {
			documentTypeMappingConfig.setId(0);
		}
	}

	/**
	 * @param dbExportConnection the dbExportConnection to set
	 */
	public void setDbExportConnection(Connections dbExportConnection) {
		if (null == documentTypeMappingConfig && dbExportConnection != null) {
			documentTypeMappingConfig = new DocumentTypeMappingConfig();
			documentTypeMappingConfig.setDocumentType(this);
		}
		if (null != documentTypeMappingConfig) {
			documentTypeMappingConfig.setDatabaseExportConnections(dbExportConnection);
		}
	}

	/**
	 * @return the fuzzyConnection
	 */
	public Connections getFuzzyConnection() {
		return documentTypeMappingConfig == null ? null : documentTypeMappingConfig.getFuzzyConnections();
	}

	/**
	 * @param fuzzyConnection the fuzzyConnection to set
	 */
	public void setFuzzyConnection(Connections fuzzyConnection) {
		if (null == documentTypeMappingConfig && fuzzyConnection != null) {
			documentTypeMappingConfig = new DocumentTypeMappingConfig();
			documentTypeMappingConfig.setDocumentType(this);
		}
		if (null != documentTypeMappingConfig) {
			documentTypeMappingConfig.setFuzzyConnections(fuzzyConnection);
		}
	}
}
