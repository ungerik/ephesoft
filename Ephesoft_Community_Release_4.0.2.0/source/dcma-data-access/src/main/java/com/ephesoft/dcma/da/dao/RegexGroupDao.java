...
/**
 * The interface <code>RegexGroupDao</code> is a database access for Regex Pool Service for RegexGroup.
 * 
 * @author Ephesoft
 * 
 ...
 */
public interface RegexGroupDao extends CacheableDao<RegexGroup> {
	...
	/**
	 * Inserts the Regex Group object.
	 * 
	 * @param regexGroup {@link RegexGroup}
	 * @return boolean true if insertion was successful.
	 */
	boolean insertGroup(RegexGroup regexGroup);

	/**
	 * Updates the Regex Group object.
	 * 
	 * @param regexGroup {@link RegexGroup}
	 * @return boolean true if updation was successful.
	 */
	boolean updateGroup(RegexGroup regexGroup);

	/**
	 * Removes the Regex Group object.
	 * 
	 * @param regexGroup {@link Long}
	 * @return boolean true if removal was successful.
	 */
	boolean removeGroup(Long identifier);
