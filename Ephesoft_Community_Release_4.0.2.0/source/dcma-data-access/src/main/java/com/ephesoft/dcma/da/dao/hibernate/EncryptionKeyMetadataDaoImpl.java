...
@Repository
public class EncryptionKeyMetadataDaoImpl extends HibernateDao<EncryptionKeyMetaData> implements EncryptionKeyMetadataDao {
	...
	@Override
	public void saveOrUpdate(EncryptionKeyMetaData object) {
