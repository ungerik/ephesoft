...
public class BatchClassPluginConfigServiceImpl implements BatchClassPluginConfigService {
	...
	@Override
	public List<BatchClassPluginConfig> getBatchClassPluginConfigByDataType(final DataType dataType) {
		return batchClassPluginConfigDao.getBatchClassPluginConfigByDataType(dataType);
	}
