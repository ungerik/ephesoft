...
@Entity
@Table(name = "advanced_kv_extraction_detail")
@org.hibernate.annotations.Cache(usage = org.hibernate.annotations.CacheConcurrencyStrategy.READ_WRITE)
public class AdvancedKVExtractionDetail extends AbstractChangeableEntity implements Serializable {
	...
	@Column(name = "is_multipage", nullable = false)
