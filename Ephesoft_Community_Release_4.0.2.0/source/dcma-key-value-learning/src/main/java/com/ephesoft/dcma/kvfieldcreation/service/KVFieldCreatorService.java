...
public interface KVFieldCreatorService {
	 ...
	 * @throws DCMAException {@link DCMAException} if any error or exception occurs.
	 */
	 ...
	 * @param value is the <code>fieldValue</code> required
	 * @param hocrPage is the {@link HocrPage} of HOCR file provided
	 * @return {@link List} containing all {@link KVExtraction} or null if some problem occurs in getting list.
	 * @throws DCMAException {@link DCMAException} if any error or exception occurs .
	 */
	List<KVExtraction> createKeyValueFieldAPI(final String batchClassIdentifier, final String value, final HocrPage hocrPage)
