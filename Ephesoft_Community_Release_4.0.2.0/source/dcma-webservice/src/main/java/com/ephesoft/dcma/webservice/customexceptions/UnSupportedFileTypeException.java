...
/**
 * The Class UnSupportedFileTypeException.
 * The class to represent the 'un-supported file type' error while a call to a webservice is made.
 *
 * @author Ephesoft
 * <b>
 ...
 */
public class UnSupportedFileTypeException extends WebServicesException {
	...
	public UnSupportedFileTypeException() {
		super(WebServiceConstants.UNSUPPORTED_FILE_TYPE_EXCEPTION_MESSAGE,
				new RestError(HttpStatus.FORBIDDEN, WebServiceConstants.UNSUPPORTED_FILE_TYPE_EXCEPTION_CODE,						
