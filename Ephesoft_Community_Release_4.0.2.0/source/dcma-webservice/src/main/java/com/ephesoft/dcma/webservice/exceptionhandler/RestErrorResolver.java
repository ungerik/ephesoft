...
/**
 * A {@code RestErrorResolver} resolves an exception and produces a {@link RestError} instance that can be used to render a Rest error
...
public interface RestErrorResolver {
	 ...
	 * @return a resolved {@code RestError} instance to render as the response body or <code>null</code> for default processing
	 */
