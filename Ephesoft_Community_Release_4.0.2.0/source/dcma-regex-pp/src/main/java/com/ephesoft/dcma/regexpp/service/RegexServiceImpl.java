...
public class RegexServiceImpl implements RegexService {
	...
	@Override
	public void regexPPReaderAPI(final String batchClassID,final List<Document> xmlDocuments,final String batchLocalPath) throws DCMAException {
		try {
			LOGGER.info("batchClassId : " + batchClassID);
			regexReader.readRegexAPI(batchClassID, xmlDocuments, batchLocalPath);
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
			throw new DCMAException(e.getMessage(), e);
		}
