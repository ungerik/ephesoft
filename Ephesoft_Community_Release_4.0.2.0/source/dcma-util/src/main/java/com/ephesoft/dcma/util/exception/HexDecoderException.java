...
/**
 * Thrown when hexadecimal value when cannot be decoded into the corresponding String value. The case when the supplied hexadecimal
 * value is not valid.
 * 
 * @author Ephesoft.
 * @version 1.0.
 * @see Exception
 */
public class HexDecoderException extends Exception {
	...
	/**
	 * Constructs a new HexDecoderException with <code>null</code> as its detail message. The cause is not initialized, and may
	 * subsequently be initialized by a call to {@link #initCause}.
	 */
	public HexDecoderException() {
		super();
	}
	 ...
	 */
	public HexDecoderException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public HexDecoderException(String message) {
		super(message);
	}

	/**
	 * Constructs a new hex decoder Exception with the specified cause and a detail message of
	 ...
	 *            permitted, and indicates that the cause is nonexistent or unknown.)
	 */
	public HexDecoderException(Throwable throwable) {
		super(throwable);
	}
}
