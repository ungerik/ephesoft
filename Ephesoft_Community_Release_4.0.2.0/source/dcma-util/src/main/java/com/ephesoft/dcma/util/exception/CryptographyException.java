...
/**
 * Exception which is thrown when there is an error occurred while encrypting or de-crypting the data.
 * <p>
 * The error can occur while because of padding required for the data corresponding to the algorithm, invalid key for encryption,
 * invalid data to encrypt/decrypt etc.
 * </p>
 * 
 * @author Ephesoft
 * @version 1.0.
...
public class CryptographyException extends Exception {
	...
	/**
	 * Constructs a new CryptographyException with <code>null</code> as its detail message. The cause is not initialized, and may
	...
	/**
	 * Constructs a new Cryptography Exception with the specified cause and a detail message of
