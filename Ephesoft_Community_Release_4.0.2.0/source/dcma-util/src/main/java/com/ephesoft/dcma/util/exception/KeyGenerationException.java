...
/**
 * Thrown when the key cannot be generated at any specified level Batch Instance Key, Batch Class key, Lucene Key etc.
 * 
 * @author Ephesoft.
 * @version 1.0
 * @see Exception
...
public class KeyGenerationException extends Exception {
	...
	/**
	 * Constructs a new KeyGenerationException with <code>null</code> as its detail message. The cause is not initialized, and may
	...
	/**
	 * Constructs a new KeyGeneration Exception with the specified cause and a detail message of
	 ...
	 *            permitted, and indicates that the cause is nonexistent or unknown.)
	 */
	public KeyGenerationException(Throwable throwable) {
		super(throwable);
	}
}
