...
public interface DomainEntity extends EntityObject {
	...
	/**
	 * Method to get the CreationDate.
	 * 
	 * @return creationDate {@link Date}
	 */
	...
	/**
	 * Method to get the EntityState.
	 * 
	 * @return entityState {@link EntityState}
	 */
	EntityState getEntityState();

	/**
	 * Method to set the EntityState.
	 * 
	 * @param entityState {@link EntityState}
	 */
	void setEntityState(EntityState entityState);

	/**
	 * Enum for EntityState definition.
	 */
