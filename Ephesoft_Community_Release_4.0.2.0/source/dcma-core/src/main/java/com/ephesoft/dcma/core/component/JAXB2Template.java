...
public class JAXB2Template {
	...
	private String insertNewRowScriptName;

	/**
	 * Name of folder with mapping files for Export to Image Import.
	 */
	private String exportToImageImportPluginMappingFolderName;

	/**
	 * Name of key value learning folder.
	 */
	private String keyValueLearningFolderName;
	 ...
	 * @param keyValueLearningFolderName {@link String} name of key value learning folder.
	 */
	public JAXB2Template(Jaxb2Marshaller jaxb2Marshaller, String baseFolderLocation, String localFolderLocation,
			...
			String advancedTestTableFolder, String dbExportPluginMappingFolderName, String insertNewRowScriptName,
			final String exportToImageImportPluginMappingFolderName, final String keyValueLearningFolderName) {
		super();
		...
		this.insertNewRowScriptName = insertNewRowScriptName;
		this.exportToImageImportPluginMappingFolderName = exportToImageImportPluginMappingFolderName;
		this.keyValueLearningFolderName = keyValueLearningFolderName;
	}
	...
	/**
	 * Returns the script name to get fire on inserting a new table row.
	 * 
	 * @return {@link String} the script name
	 */
	public String getInsertNewRowScriptName() {
		return insertNewRowScriptName;
	}

	/**
	 * Sets the script name to get fired on inserting a new table row.
	 * 
	 * @param insertNewRowScriptName {@link String} the script name to set.
	 */
	public void setInsertNewRowScriptName(String insertNewRowScriptName) {
		this.insertNewRowScriptName = insertNewRowScriptName;
	}

	/**
	 * Gets exportToImageImportPluginMappingFolderName.
	 * 
	 * @return {@link String}
	 */
	public String getExportToImageImportPluginMappingFolderName() {
		return exportToImageImportPluginMappingFolderName;
	}

	/**
	 * Sets exportToImageImportPluginMappingFolderName.
	 * 
	 * @param exportToImageImportPluginMappingFolderName {@link String}
	 */
	public void setExportToImageImportPluginMappingFolderName(final String imageImportPluginMappingFolderName) {
		this.exportToImageImportPluginMappingFolderName = imageImportPluginMappingFolderName;
	}

	/**
	 * Returns the key-value-learning folder name.
	 * 
	 * @return {@link String} Key Value Learning Folder Name
	 */
	public String getKeyValueLearningFolderName() {
		return keyValueLearningFolderName;
	}

	/**
	 * Sets the key value learning folder name.
	 * 
	 * @param keyValueLearningFolderName {@link String} containing value to be set for key value learning folder name.
	 */
	public void setKeyValueLearningFolderName(final String keyValueLearningFolderName) {
		this.keyValueLearningFolderName = keyValueLearningFolderName;
	}
