...
/**
 * Class to keep document names successfully inserted, already exist and getting error while inserting in db.
 * 
 * @author ephesoft
 * @version 1.0
 * 
...
public class ImportExportDocument implements Serializable {
	...
	public ImportExportDocument(String documentType, boolean isAlreadyExist, boolean isError, boolean isSerError) {
		super();
