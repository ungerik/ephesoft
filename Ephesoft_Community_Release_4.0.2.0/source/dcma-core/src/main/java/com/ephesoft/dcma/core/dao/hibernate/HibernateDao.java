...
public abstract class HibernateDao<T> implements Dao<T> {
	...
	/**
	 * {@link EphesoftLogger} Constant for logs of this class.
	 */
	private static final EphesoftLogger LOGGER = EphesoftLoggerFactory.getLogger(HibernateDao.class);
	...
	protected EphesoftCriteria criteria(Class<?> clazz) {
		return EphesoftCriteria.forClazz(clazz);
	}
