...
public enum ConnectionType {
	...
	MYSQL("MYSQL", "jdbc:mysql:", "com.mysql.jdbc.Driver"), MSSQL("MSSQL", "jdbc:sqlserver:", "net.sourceforge.jtds.jdbc.Driver"),
	MSSQL_WINDOWS_AUTHENTICATION("MSSQL Windows Authentication", "jdbc:sqlserver:", "net.sourceforge.jtds.jdbc.Driver"),
	MSSQL_ALWAYSON("MSSQL AlwaysOn", "jdbc:sqlserver:", "com.microsoft.sqlserver.jdbc.SQLServerDriver"), ORACLE("ORACLE",
