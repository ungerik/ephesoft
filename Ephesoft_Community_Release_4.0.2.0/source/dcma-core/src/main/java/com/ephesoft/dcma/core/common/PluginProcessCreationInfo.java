 ...
 * @version 1.0
 */
public class PluginProcessCreationInfo {
	 ...
	 */
	public PluginProcessCreationInfo(String subProcessName) {
		this(subProcessName, false, ICommonConstants.EMPTY_STRING, ICommonConstants.EMPTY_STRING);
	}
	 ...
	 */
	public PluginProcessCreationInfo(String subProcessName, boolean isScriptingPlugin, String serviceName, String methodName) {
