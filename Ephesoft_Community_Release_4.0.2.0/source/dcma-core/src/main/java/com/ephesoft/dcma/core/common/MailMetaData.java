...
public class MailMetaData {
	...
	private static final String CARRAIGE_RETURN_STRING_HTML_FILE = "<p>";
	...
	private String carriageReturnNewLine;
	...
	public void setCarriageReturnNewLine(String carriageReturnNewLine) {
		this.carriageReturnNewLine = carriageReturnNewLine;
	}
	...
	public String toString() {
		if (carriageReturnNewLine == null) {
			carriageReturnNewLine = CARRAIGE_RETURN_STRING_HTML_FILE;
		}
		StringBuffer stringBuffer = new StringBuffer();
		stringBuffer.append("From: ");
		stringBuffer.append(fromAddress);
		stringBuffer.append(carriageReturnNewLine);
		if (toAddresses != null) {
