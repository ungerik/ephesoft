...
public interface KVExtractionService {
	 ...
	 * @throws DCMAException If not able to extract Key Value document level fields. {@link DCMAException}
	 */
	 ...
	 * 
	 * @param updtDocList {@link List}<{@link DocField} >
	 * @param hocrPages {@link HocrPages}
	 * @param params {@link ExtractKVParams}
	 * @keyRectangleCoordinates stores key coordinaltes as selected by overlay. {@link Coordinates}
	 * @valueRectangleCoordinates value coordinaltes as selected by overlay. {@link Coordinates}
	 * @return {@link Boolean}
	 * 
	...
	boolean extractKVDocumentFieldsFromHOCR(List<DocField> updtDocList, HocrPages hocrPages, ExtractKVParams params,
			Coordinates keyRectangleCoordinates, Coordinates valueRectangleCoordinates) throws DCMAException;
	 ...
	 * @throws DCMAException {@link DCMAException}
	 */
	boolean extractKVFromHOCRForBatchClass(List<DocField> updtDocList, HocrPages hocrPages, String batchClassIdentifier,
			String documentType) throws DCMAException;

	/**
	 * Performs KV extraction on the input and adds result to the batch
	 * 
	 ...
	 */
	void extractKVForExtraction(String folderLocation, String batchClassIdentifier, Batch batch) throws DCMAApplicationException;
}
