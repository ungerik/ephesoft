...
public class KVExtractionServiceImpl implements KVExtractionService {
	...
	@Override
	public boolean extractKVDocumentFieldsFromHOCR(List<DocField> updtDocList, HocrPages hocrPages, ExtractKVParams params,
			Coordinates keyRectangleCoordinates, Coordinates valueRectangleCoordinates) throws DCMAException {
		try {
			return keyValueExtraction.extractFieldsFromHOCR(updtDocList, hocrPages, params, keyRectangleCoordinates,
	...
	@Transactional
	@Override
	public void extractKVForExtraction(String folderLocation, String batchClassIdentifier, Batch batch) throws DCMAApplicationException {
		try {
			keyValueExtraction.extractFromHOCRForExtraction(folderLocation, batchClassIdentifier, batch);
		} catch (Exception e) {
			LOGGER.error(e.getMessage(), e);
