...
public class SecurityTokenHandler {
	...
	public static String generateToken() {
		...
		final String generatedToken = getEncryptedString(rand.nextLong() + "");
		if (generatedToken != null) {
			...
			tokenToBeReturned = getEncodedString(getEncodedString(generatedToken));
		}
		return tokenToBeReturned;
	}

	private static String getEncryptedString(String toEncryptString) {
