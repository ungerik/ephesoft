...
public class EncryptorDecryptor {
	...
	public synchronized byte[] startCrypting(byte[] data, byte[] salt, boolean isEncryption) throws CryptographyException {
		...
		try {
			...
			if (isEncryption) {
				log.error("Encryption : Key used is invalid", e);
				throw new CryptographyException("Key used is invalid", e);
			} else {
				log.error("Decryption : Key used is invalid", e);
				throw new CryptographyException("Key used is invalid", e);
			}
		} catch (NoSuchAlgorithmException e) {
			if (isEncryption) {
				log.error("Encryption : Algorithm used does not exist", e);
				throw new CryptographyException("Algorithm used does not exist", e);
			} else {
				log.error("Decryption : Algorithm used does not exist", e);
				throw new CryptographyException("Algorithm used does not exist", e);
			}
		} catch (NoSuchPaddingException e) {
			if (isEncryption) {
				log.error("Encryption : Padding used does not exist", e);
				throw new CryptographyException("Padding used does not exist", e);
			} else {
				log.error("Decryption : Padding used does not exist", e);
				throw new CryptographyException("Padding used does not exist", e);
			}
		} catch (InvalidKeyException e) {
			if (isEncryption) {
				log.error("Encryption : Key generated is invalid", e);
				throw new CryptographyException("Key generated is invalid", e);
			} else {
				log.error("Decryption : Key generated is invalid", e);
				throw new CryptographyException("Key generated is invalid", e);
			}
		} catch (InvalidAlgorithmParameterException e) {
			if (isEncryption) {
				log.error("Encryption : Algorithm parameter is invalid", e);
				throw new CryptographyException("Algorithm parameter is invalid", e);
			} else {
				log.error("Decryption : Algorithm parameter is invalid", e);
				throw new CryptographyException("Algorithm parameter is invalid", e);
			}
		} catch (IllegalBlockSizeException e) {
			if (isEncryption) {
				log.error("Encryption : Block size is illegal", e);
				throw new CryptographyException("Block size is illegal", e);
			} else {
				log.error("Decryption : Block size is illegal", e);
				throw new CryptographyException("Block size is illegal", e);
			}
		} catch (BadPaddingException e) {
			if (isEncryption) {
				log.error("Encryption : Padding done is invalid", e);
				throw new CryptographyException("Padding done is invalid", e);
			} else {
				log.error("Decryption : Padding done is invalid", e);
				throw new CryptographyException("Padding done is invalid", e);
			}
		}
		return finalBytes;
