...
public interface BarcodeExtractionService {
	 ...
	 * @throws DCMAException
	 * @return {@link List}<{@link DocField}>: list of document level fields
	 */
	...
	/**
	 * Performs bar code extraction on the input
	 * @param batchClassIdentifier {@link String}
	 * @param folderLocation {@link String}
	 * @param batch {@link Batch}
	 * @throws DCMAApplicationException
	 */
	void extractPageBarCodeForExtraction(String batchClassIdentifier, String folderLocation, Batch batch) throws DCMAApplicationException;
}
