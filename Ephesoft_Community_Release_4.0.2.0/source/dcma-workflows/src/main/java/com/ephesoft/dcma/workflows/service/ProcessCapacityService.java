...
/**
 * This interface represents a service that gives the details about Processing Capacity of the server.
 * 
 * @author Ephesoft
 * 
 ...
 */
public interface ProcessCapacityService {
	 ...
	 * 
	 * @param maxProcessCapacity int
	 */
	void setMaxCapacity(int maxProcessCapacity);
}
