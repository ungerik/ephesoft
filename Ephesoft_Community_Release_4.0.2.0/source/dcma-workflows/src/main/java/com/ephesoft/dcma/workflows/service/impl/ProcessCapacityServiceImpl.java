...
/**
 * This class represents service to get details about process capacity of the server.
 * 
 * @author Ephesoft
 * 
 ...
 */
public class ProcessCapacityServiceImpl implements ProcessCapacityService {

	/**
	 * int Max process capacity.
	 */
