...
/**
 * This class represents the actions taken by the listener executed at the start of workflow of a batch.
 * 
 * @author Ephesoft
 * 
 ...
 */
public class WorkflowStatusStartListener implements ExecutionListener {
	 ...
	 */
	private static final EphesoftLogger LOGGER = EphesoftLoggerFactory.getLogger(WorkflowStatusStartListener.class);
	...
	/**
	 * Executes steps for listener of the start of workflow of a batch.
	 */
	@Override
