...
/**
 * This interface represents a acquire job command that must be implemented by every third party's Acquire job command used for
 * Ephesoft.
 * 
 * @author Ephesoft
 * 
 ...
 */
public interface EphesoftAcquireJobsCmd {
