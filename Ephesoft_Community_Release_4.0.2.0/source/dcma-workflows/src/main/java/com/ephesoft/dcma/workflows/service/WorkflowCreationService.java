...
/**
 * This interface represents a service to create a BPMN XML for a module or a batch class.
 * 
 * @author Ephesoft
 * 
...
public interface WorkflowCreationService {
	...
	/**
	 * Writes process definitions for a batch class or a module
	 * 
	 ...
	 * @return {@link String}
	 */
	String writeProcessDefinitions(String workflowPath, String processName, List<ProcessDefinitionInfo> subProcessList,
			boolean isWorkflow) throws DCMAException;
}
