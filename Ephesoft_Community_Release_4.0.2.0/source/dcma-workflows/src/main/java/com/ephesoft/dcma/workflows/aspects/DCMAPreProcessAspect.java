...
/**
 * This class represents the aspects for Pre-processing for batches for every plugin of execution.
 * 
 * @author Ephesoft
 * 
...
public class DCMAPreProcessAspect {
	 ...
	 */
	private static final EphesoftLogger LOGGER = EphesoftLoggerFactory.getLogger(DCMAPreProcessAspect.class);
