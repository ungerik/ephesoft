...
public class HTMLDocument {
	...
	public static Document Document(final File f) throws IOException,
		...
		try {
			...
			final NodeList nodeList = doc.getElementsByTagName("HocrContent");
			if (null != nodeList) {
				hocrContent = nodeList.item(0).getTextContent();
			}
			final NodeList titleNodelist  = doc.getElementsByTagName("Title");
		...
		if (null == hocrContent) {
			final String err = "Hocr content can not be null.";
		...
		doc.add(new Field("summary", hocrContent.toString(), Field.Store.NO,
