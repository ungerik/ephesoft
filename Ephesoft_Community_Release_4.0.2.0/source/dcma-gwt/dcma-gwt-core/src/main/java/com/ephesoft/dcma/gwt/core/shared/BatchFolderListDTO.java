...
public class BatchFolderListDTO implements IsSerializable {
	...
	/**
	 * Reference to export to image import plugin's mapping folder name.
	 */
	private String exportToImageImportPluginMapping;
	...
	public void initFolderList() {
		...
		HashMap<String, String> exportToImageImportPropertyMap = new HashMap<String, String>();
		exportToImageImportPropertyMap.put(FOLDER_NAME, exportToImageImportPluginMapping);
		exportToImageImportPropertyMap.put(CHECKED, "true");
		exportToImageImportPropertyMap.put(ENABLED, "false");
		folderList.add(exportToImageImportPropertyMap);
		 ...
		 * fileboundPluginPropertyMap.put(FOLDER_NAME, fileboundPluginMappingFolderName); fileboundPluginPropertyMap.put(CHECKED,
		 * "true"); fileboundPluginPropertyMap.put(ENABLED, "false"); folderList.add(fileboundPluginPropertyMap);
		 */
	...
	/**
	 * Gets exportToImageImportPluginMapping.
	 * 
	 * @return {@link String}
	 */
	public String getExportToImageImportPluginMapping() {
		return exportToImageImportPluginMapping;
	}

	/**
	 * Sets exportToImageImportPluginMapping
	 * 
	 * @param exportToImageImportPluginMapping {@link String}
	 */
	public void setExportToImageImportPluginMapping(String exportToImageImportPluginMapping) {
		this.exportToImageImportPluginMapping = exportToImageImportPluginMapping;
	}
}
