...
public class SSOAuthorizer extends AbstractEphesoftAuthorizer {
	...
	public Set<String> getUserRoles(final HttpServletRequest httpServletRequest) {
		...
		if (null != httpServletRequest) {
			...
			userGroups = RequestUtil.getSessionSetAttribute(httpServletRequest, CoreCommonConstants.SESSION_USER_GROUPS_KEY);
			if (null == userGroups) {
				...
				RequestUtil.setSessionAttribute(httpServletRequest, CoreCommonConstants.SESSION_USER_GROUPS_KEY, userGroups);
			}
		}
