 ...
 * 
 */
public class LicenseTypeDTO implements IsSerializable {
	...
	/**
	 * To get the license description.
	 * 
	 * @return String
	 */
	...
	/**
	 * To set the license description.
	 * 
	...
	/**
	 * Sets the license type identifier.
	 * 
	 * @param identifier
	 */
