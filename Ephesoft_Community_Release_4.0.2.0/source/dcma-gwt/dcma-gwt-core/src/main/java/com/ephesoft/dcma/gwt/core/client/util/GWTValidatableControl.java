...
public enum GWTValidatableControl {
	...
	public static ValidatableWidget<SuggestionBox> createGWTControl(String type, String actualValue, final String fieldName,
			List<String> alternateValues, List<String> patternStr, final String sampleValue, final String patternStrSeparator) {
		...
		if (patternStr != null)
			validatableSBox.addValidator(new PatternValidator(suggestionBox, patternStr, patternStrSeparator));
		validatableSBox.toggleValidDateBox();
	...
	public static ValidatableWidget<SuggestionBox> createGWTControl(String type, String actualValue, List<String> alternateValues) {
		return createGWTControl(type, actualValue, null, alternateValues, null, null, null);
	}
