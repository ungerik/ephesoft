...
public class DocumentTypeDBBean implements IsSerializable {
	...
	/**
	 * @param secondPageProjectFileName the secondPageProjectFileName to set
	 */
	public void setSecondPageProjectFileName(String secondPageProjectFileName) {
		this.secondPageProjectFileName = secondPageProjectFileName;
	}
	...
	/**
	 * @param thirdPageProjectFileName the thirdPageProjectFileName to set
	 */
	public void setThirdPageProjectFileName(String thirdPageProjectFileName) {
		this.thirdPageProjectFileName = thirdPageProjectFileName;
	}
	...
	/**
	 * @param fourthPageProjectFileName the fourthPageProjectFileName to set
	 */
	public void setFourthPageProjectFileName(String fourthPageProjectFileName) {
		this.fourthPageProjectFileName = fourthPageProjectFileName;
	}
