...
public class ListBoxPatternValidator implements Validator {
	...
	/**
	 * Instantiates the ListBoxPatternValidator with the values passed.
	 * 
	 * @param listBox {@link ListBox} The instance of ListBox.
	 ...
	 */
	public ListBoxPatternValidator(final ListBox listBox, final List<String> patternStr, final String patternStrSeparator) {
		this.listBox = listBox;
		this.patternStr = patternStr;
