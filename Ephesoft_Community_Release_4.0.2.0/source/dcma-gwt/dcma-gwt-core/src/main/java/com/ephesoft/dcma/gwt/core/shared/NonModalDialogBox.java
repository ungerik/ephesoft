 ...
 * </p>
 * <p>
 * This will ignore the events of the screen behind the dialog box but not the events that will pop up above this.
 * </p>
 * 
 * @author Ephesoft
 * @version 1.0
 ...
 * 
 */
public class NonModalDialogBox extends DialogBox {

	/**
	 * Creates a non modal dialog box with the default functionality of autohide to false.
	 */
	public NonModalDialogBox() {
		this(false);
	}
	 ...
	 */
	public NonModalDialogBox(boolean autoHide) {
