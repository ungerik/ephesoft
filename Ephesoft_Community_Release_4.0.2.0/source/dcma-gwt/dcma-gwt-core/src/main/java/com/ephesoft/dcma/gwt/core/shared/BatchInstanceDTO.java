...
public class BatchInstanceDTO implements IsSerializable {
	...
	private BatchInstanceRetriesDTO batchInstanceRetriesDTO;
	...
	public BatchInstanceRetriesDTO getBatchInstanceRetriesDTO() {
		return batchInstanceRetriesDTO;
	}

	
	public void setBatchInstanceRetriesDTO(BatchInstanceRetriesDTO batchInstanceRetriesDTO) {
		this.batchInstanceRetriesDTO = batchInstanceRetriesDTO;
	}
}
